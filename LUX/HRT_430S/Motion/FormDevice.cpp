...
void __fastcall TFrmDevice::btNewClick(TObject *Sender)
{
    ...
    switch (index) {
        ...
        case 3: //Rename.
            ...
            SV_LoadJobFile(edToName -> Text.c_str());
...
//---------------------------------------------------------------------------
void TFrmDevice::UpdetePreViewOptn()
{
    pnDeviceType -> Caption = OM.ReVwOptn.sDeviceType;
    pnDeviceName -> Caption = OM.ReVwOptn.sDeviceName;
    pnCnrtValue  -> Caption = OM.ReVwOptn.i1ChLedCur ;
    pnZnnr       -> Caption = OM.ReVwOptn.bUseZener ? "유":"무" ;
    pnTime       -> Caption = OM.ReVwOptn.iWaitDelay / 1000;

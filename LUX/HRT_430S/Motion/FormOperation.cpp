    ...
    : TForm(Owner)
{
    ...
    btMan1_13 -> Caption = "[" + AnsiString(mcETC_MasterInsp        ) + "]" + "Master Inspection";  btMan1_13 -> Tag = (int)mcETC_MasterInsp     ; btMan1_13 -> Visible = true ;
    ...
    btMan2_13 -> Caption = "[" + AnsiString(mcETC_MasterInsp        ) + "]" + "Master Inspection";  btMan2_13 -> Tag = (int)mcETC_MasterInsp     ; btMan2_13 -> Visible = true ;
...
*/
    ...
    btMan3_13 -> Caption = "[" + AnsiString(mcETC_MasterInsp        ) + "]" + "Master Inspection";  btMan3_13 -> Tag = (int)mcETC_MasterInsp     ; btMan3_13 -> Visible = true  ;
...
//  btMan3_5  -> Caption = "[" + AnsiString(mcWRK_ReWork            ) + "]" + "Probe ReWork"     ;  btMan3_5  -> Tag = (int)mcWRK_ReWork         ; btMan3_5  -> Visible = true ;
    ...
    btMan5_13 -> Caption = "[" + AnsiString(mcETC_MasterInsp        ) + "]" + "Master Inspection";  btMan5_13 -> Tag = (int)mcETC_MasterInsp     ; btMan5_13 -> Visible = true  ;
...
//    btMan7_7  -> Caption = "[" + AnsiString(                        ) + "]" + "RemoveStrip"      ;  btMan7_7  -> Tag = (int)mcETC_RemoveStrip    ; btMan7_7  -> Visible = false;
    btMan7_13 -> Caption = "[" + AnsiString(mcETC_MasterInsp        ) + "]" + "Master Inspection";  btMan7_13 -> Tag = (int)mcETC_MasterInsp     ; btMan7_13 -> Visible = true  ;
...
//
    ...
    btLotOpen -> Enabled = !OM.MstOptn.bNotUstLot ;//&& (SEQ._bInspMstr || OM.MstOptn.bMstrPkgSkip);
    ...
    if(OM.MstOptn.bUsedTempRS232){
        ...
        for(int i = 1 ; i <= MAX_TEMP_CH + 1; i++) {
            ...
            if(i == 1) OM.CmnOptn.iTmprtr = iCrntTemp ;
        }
...
void __fastcall TFrmOperation::btLotOpenClick(TObject *Sender)
{
    ...
    if(!SEQ._bInspMstr && !OM.MstOptn.bMstrPkgSkip) FrmMstPkg  -> Show();
    if( SEQ._bInspMstr ||  OM.MstOptn.bMstrPkgSkip) FrmLotOpen -> ShowModal() ;
}
//---------------------------------------------------------------------------
...
{
    if(FM_GetLevel() == (EN_LEVEL)lvOperator) return ;
    // juhyeon

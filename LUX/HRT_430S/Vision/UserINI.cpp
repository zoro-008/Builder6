...
void __fastcall TUserINI::Load(char *Path , char *Section , char *Name , float &Data)
{
    double dTemp ;
    Load(Path , Section , Name , dTemp);
    Data = dTemp ;
...
void __fastcall TUserINI::Save(char *Path , char *Section , char *Name , float  Data)
{
    double dTemp = Data ;
    Save(Path , Section , Name , dTemp);
}
void __fastcall TUserINI::Save(char *Path , char *Section , char *Name , float *Data)
{
    double dTemp = *Data ;
...
void __fastcall TUserINI::Save(char *Path , char *Section , char *Name , bool *Data)
{
    ...
    bool bData = *Data ;
    pINI -> WriteBool(Section , Name , bData);
    delete pINI;
}
...
void __fastcall TUserINI::Load(AnsiString Path , char *Section , char *Name , float &Data)
{
    double dTemp ;
    Load(Path.c_str() , Section , Name , dTemp);
    Data = dTemp ;
}
void __fastcall TUserINI::Load(AnsiString Path , char *Section , char *Name , float *Data)
{
...
void __fastcall TUserINI::Save(AnsiString Path , char *Section , char *Name , float  Data)
{
    double dTemp = Data ;
    Save(Path.c_str() , Section , Name , dTemp);
}
void __fastcall TUserINI::Save(AnsiString Path , char *Section , char *Name , float *Data)
{
    double dTemp = *Data ;
...
void __fastcall TUserINI::Load(AnsiString Path , AnsiString Section , char *Name , float &Data)
{
    double dTemp ;
    Load(Path.c_str() , Section.c_str() , Name , dTemp);
    Data = dTemp ;
}
void __fastcall TUserINI::Load(AnsiString Path , AnsiString Section , char *Name , float *Data)
{
...
void __fastcall TUserINI::Save(AnsiString Path , AnsiString Section , char *Name , float  Data)
{
    double dTemp = Data ;
    Save(Path.c_str() , Section.c_str() , Name , dTemp);
}
void __fastcall TUserINI::Save(AnsiString Path , AnsiString Section , char *Name , float *Data)
{
    double dTemp = *Data ;
...
void __fastcall TUserINI::Load(AnsiString Path , AnsiString Section , AnsiString Name , float &Data)
{
    double dTemp ;
    Load(Path.c_str() , Section.c_str() , Name.c_str() , dTemp);
    Data = dTemp ;
...
void __fastcall TUserINI::Save(AnsiString Path , AnsiString Section , AnsiString Name , float  Data)
{
    double dTemp = Data ;
    Save(Path.c_str() , Section.c_str() , Name.c_str() , dTemp);
}
void __fastcall TUserINI::Save(AnsiString Path , AnsiString Section , AnsiString Name , float *Data)
{
    double dTemp = *Data ;
...
void __fastcall TUserINI::Load(char *Path , AnsiString Section , AnsiString Name , float &Data)
{
    double dTemp ;
    Load(Path , Section.c_str() , Name.c_str() , dTemp);
    Data = dTemp ;
}
void __fastcall TUserINI::Load(char *Path , AnsiString Section , AnsiString Name , float *Data)
{
...
void __fastcall TUserINI::Save(char *Path , AnsiString Section , AnsiString Name , float  Data)
{
    double dTemp = Data ;
    Save(Path , Section.c_str() , Name.c_str() , dTemp);
}
void __fastcall TUserINI::Save(char *Path , AnsiString Section , AnsiString Name , float *Data)
{
    double dTemp = *Data ;
...
void __fastcall TUserINI::Load(char *Path , char *Section , AnsiString Name , float &Data)
{
    double dTemp ;
    Load(Path , Section , Name.c_str() , dTemp);
    Data = dTemp ;
}
void __fastcall TUserINI::Load(char *Path , char *Section , AnsiString Name , float *Data)
{
...
void __fastcall TUserINI::Save(char *Path , char *Section , AnsiString Name , float  Data)
{
    double dTemp = Data ;
    Save(Path , Section , Name.c_str() , dTemp);
}
void __fastcall TUserINI::Save(char *Path , char *Section , AnsiString Name , float *Data)
{
    double dTemp = *Data ;
...
void __fastcall TUserINI::Load(char *Path , AnsiString Section , char *Name , float &Data)
{
    double dTemp ;
    Load(Path , Section.c_str() , Name , dTemp);
    Data = dTemp ;
}
void __fastcall TUserINI::Load(char *Path , AnsiString Section , char *Name , float *Data)
{
...
void __fastcall TUserINI::Save(char *Path , AnsiString Section , char *Name , float  Data)
{
    double dTemp = Data ;
    Save(Path , Section.c_str() , Name , dTemp);
}
void __fastcall TUserINI::Save(char *Path , AnsiString Section , char *Name , float *Data)
{
    double dTemp = *Data ;
...
void __fastcall TUserINI::Load(AnsiString Path , char *Section , AnsiString Name , float &Data)
{
    double dTemp ;
    Load(Path.c_str() , Section , Name.c_str() , dTemp);
    Data = dTemp ;
}
void __fastcall TUserINI::Load(AnsiString Path , char *Section , AnsiString Name , float *Data)
{
...
void __fastcall TUserINI::Save(AnsiString Path , char *Section , AnsiString Name , float  Data)
{
    double dTemp = Data ;
    Save(Path.c_str() , Section , Name.c_str() , dTemp);
}
void __fastcall TUserINI::Save(AnsiString Path , char *Section , AnsiString Name , float *Data)
{
    double dTemp = *Data ;

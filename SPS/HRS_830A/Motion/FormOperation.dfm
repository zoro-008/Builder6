object FrmOperation: TFrmOperation
  ...
  object tmLabelTimer: TTimer
    Interval = 100
    OnTimer = tmLabelTimerTimer
    Left = 1211
    Top = 8
  end
  object tmStopToShot: TTimer
    Interval = 100
    OnTimer = tmStopToShotTimer
    Left = 1182
    Top = 8
  end
end

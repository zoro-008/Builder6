...
void __fastcall TFrmSPC::Button1Click(TObject *Sender)
{
    ...
    LT.LotInfo.sWaferName  = "waf";
    LT.LotInfo.sJobFile    = "job";
    LT.LotInfo.sOperator   = "kjh";
    ...
    LT.LotInfo.iWrkWafer   = 22   ;
    LT.LotInfo.iMarkChip   = 11   ;
    LT.LotInfo.iFailChip   = 00   ;
...
//    sgLotInfo -> ColWidths[2]     = 80 ;
    ...
    sPath.Delete(sPath.Pos(".csv"),4);
    sPath = sPath + "\\" + sgLot -> Cells[1][ sgLot -> Row] ;
    sPath.Delete(sPath.Pos(".csv"),4);
    sPath = sPath + ".ini";
    SPC.ReadArayData(sPath);
}
//---------------------------------------------------------------------------

...
bool TFraCyl::CheckSafe(int _iId , bool _bFwd)
{
    ...
    AnsiString sMsg = "";
         ...
         if(_iId == (int)aiSTG_ChkTblUD   ) { bRet = STG.CheckSafe((EN_ACTR_ID)_iId,_bFwd) ; }
    else if(_iId == (int)aiSTG_TrsCmpGR   ) { bRet = STG.CheckSafe((EN_ACTR_ID)_iId,_bFwd) ; }
    else if(_iId == (int)aiHED_PenMrkDU   ) { bRet = HED.CheckSafe((EN_ACTR_ID)_iId,_bFwd) ; }
    else if(_iId == (int)aiHED_PenCoverUD ) { bRet = HED.CheckSafe((EN_ACTR_ID)_iId,_bFwd) ; }
    else if(_iId == (int)aiSTG_WfrAlgnFB  ) { bRet = STG.CheckSafe((EN_ACTR_ID)_iId,_bFwd) ; }

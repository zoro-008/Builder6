...
//        bool   FindChipY  (EN_ARAY_ID _riWhre , int &r , int &c     );
    ...
    public:    /* Direct Accessable Var.  */
        ...
        //One Cycle.
        bool CycleWorkStt(); //작업시작위치로
        bool CycleReGrip (); //리그립. 여기선 안쓰게 세팅 해서 안씀.
        bool CycleWork   (); //작업 위치로 이동.
        bool CycleAtVisn (); //에프터 검사
        bool CycleBfVisn (); //비포 검사
        bool CycleWorkEnd(); //자제 배출.

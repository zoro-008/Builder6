...
/*  Blob */
CBlob Blob ;
extern "C" SVL_API bool   __stdcall IBLB_Inspect   (IImage * _pImg , TRect  _tRect , BLB_Para   _tPara , BLB_Fltr _tFltr , BLB_Rslt * _pRslt)       {g_sErrMsg="";return Blob.Inspect    ((CImage *)_pImg  , _tRect , _tPara , _tFltr             , _pRslt);}
...
/*OCV     */
COcv Ocv ;
extern "C" SVL_API bool   __stdcall IOCV_Train     (IImage * _pImg , TRect _Rect , OCV_TrPr _tTrPr ,  IArea * _pTrainArea , IImage * _pTrainImg)    {g_sErrMsg=""; return Ocv.Train      ((CImage *)_pImg , _Rect , _tTrPr , (CArea *) _pTrainArea , (CImage *) _pTrainImg);  }

...
class TTracker {
    ...
    public :
        ...
        void SetRefX(int _iRefX)  //결과값을 참조하여 트렉커의 위치를 자동으로 바꿔주려함.
        {
            m_iRefX = _iRefX ;
        }
        void SetRefY(int _iRefY )  //결과값을 참조하여 트렉커의 위치를 자동으로 바꿔주려함.
        {
            m_iRefY = _iRefY ;
        }
        int GetRefX()
...
class TRectTracker:public TTracker {
    ...
    protected :
        ...
        int  FBandMax     ; void __fastcall SetBandMax     (int  value);
    ...
    public :
        ...
        __property int  BandMax      = { read = FBandMax       , write = SetBandMax      };
...
class TOutBandRectTracker:public TTracker {
    ...
    protected :
        ...
        int  FTop         ; void __fastcall SetTop         (int  value);
        int  FHeight      ; void __fastcall SetHeight      (int  value);
        int  FWidthMax    ; void __fastcall SetWidthMax    (int  value);
        int  FHeightMax   ; void __fastcall SetHeightMax   (int  value);
    ...
    public :
        ...
        __property int  Height       = { read = FHeight        , write = SetHeight       };
        __property int  Width        = { read = FWidth         , write = SetWidth        };
        __property int  HeightMax    = { read = FHeightMax     , write = SetHeightMax    };
        __property int  WidthMax     = { read = FWidthMax      , write = SetWidthMax     };

...
void TFraCylOneBt::SetConfig(EN_ACTR_ID            _iActrId               ,
                             ...
                             CheckSafeCallbackActr _pCheckSafeCallbackActr)
{
    ...
    m_pCheckSafeCallbackActr = _pCheckSafeCallbackActr ;
    this -> Align            = alClient                ;
...
{
    if(m_pCheckSafeCallbackActr && !m_pCheckSafeCallbackActr(m_iActrId , !AT_GetCmd(m_iActrId))) return ;

...
bool CImi::Init()
{
    ...
    */
	...
	if(ImCamOpen(m_iImiCamNo, true, false, NULL , IMC_VIEW_STATIC, false, IMC_GRAB_RAW, 0, IMC_BAYER_GB_RG) != IMC_SUCCESS) {
		ShowMessage("Imi Cam" + String(m_iImiCamNo) + " can't open");
		return false;
	}
...
void CImi::UpdatePara(bool _bToTable)
{
    if(_bToTable) {
         ...
         if(bNeedRestart){ShowMessage("Please Restart The Application!"); }

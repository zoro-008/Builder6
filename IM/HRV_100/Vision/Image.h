...
class IImage {
    ...
    public :
        ...
        virtual void __stdcall operator = (IImage * _pImg)=0;  //이상한것 같아서 함수 따로 만듬.
        virtual void __stdcall CopyImage  (IImage * _pImg)=0;
    ...
    public:
        ...
        virtual bool __stdcall SetX    (int    *_pX , int _iMargin = 0)=0;
        virtual bool __stdcall SetY    (int    *_pY , int _iMargin = 0)=0;
        virtual bool __stdcall SetX    (double *_pX , int _iMargin = 0)=0;
        virtual bool __stdcall SetY    (double *_pY , int _iMargin = 0)=0;
...
class CImage : public IImage{
    ...
    public :
        ...
        void __stdcall CopyImage(IImage * _pImg)
        {
            SetSize(_pImg->GetWidth (),_pImg->GetHeight(),_pImg->GetImgBit());
    ...
    public:
        ...
        bool __stdcall SetX    (int    *_pX , int _iMargin = 0);
        bool __stdcall SetY    (int    *_pY , int _iMargin = 0);
        bool __stdcall SetX    (double *_pX , int _iMargin = 0);
        bool __stdcall SetY    (double *_pY , int _iMargin = 0);
...
extern CImage * g_pImg[MAX_IMG_ID] ;

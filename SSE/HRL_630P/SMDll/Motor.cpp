...
bool CMotor::CycleHome()
{
    ...
    if(GetCmdPos() > 240) m_dPosGap = 360.0;

    static bool  bTemp ;//디버그 할려구 잠시 추가.
    ...
    switch (HomeStat.iHomeStep) {
        ...
        case 11 :
            ...
            if(bSensorStat) {
                HomeStat.iHomeStep = 15 ; //홈밍 센서가 감지 되고 있는경우.
                return false ;
            }
            HomeStat.iHomeStep++ ;
            return false ;
        ...
        case 12 :
            ...
            //FindEdgeStop(-0.1 * dVel , dAcc , ftSnsrUpEdge);
            bTemp = GetStop() ;
            HomeStat.iHomeStep++ ;
            return false ;
        ...
        case 18 :
            ...
            //else           FindEdgeStop(-0.1 * dVel , dAcc , ftSnsrUpEdge);
            HomeStat.iHomeStep++ ;
            return false ;
        ...
        case 20 :
            ...
            //if(bUseZphase) FindEdgeEmgStop(-0.1 * dLastVel , dAcc  , ftZPhsUpEdge);

...
//#define POS_COL_WIDTH    30    345
//#define GO_COL_WIDTH     15    415
//#define INPUT_COL_WIDTH  15
#define NAME_COL_WIDTH   143
#define POS_COL_WIDTH    143
...
void CPstnMan::Init()
{
    ...
    Value[miFED_YFrt][pvFED_YFrtWait     ].sName = "Wait       " ;
    Value[miFED_YFrt][pvFED_YFrtWork     ].sName = "Work       " ;
    Value[miFED_YFrt][pvFED_YFrtFeed     ].sName = "Feed       " ;

    Value[miFED_YLer][pvFED_YLerWait     ].sName = "Wait       " ;
    Value[miFED_YLer][pvFED_YLerWork     ].sName = "Work       " ;
    Value[miFED_YLer][pvFED_YLerFeed     ].sName = "Feed       " ;

    Value[miLSR_TFrt][pvLSR_TFrtWait     ].sName = "Wait       " ;
    Value[miLSR_TFrt][pvLSR_TFrtPos1     ].sName = "Position1  " ; if(!OM.DevOptn.bUseLsrPst1){ Value[miLSR_TFrt][pvLSR_TFrtPos1 ].iType = vtHide ; }
    Value[miLSR_TFrt][pvLSR_TFrtPos2     ].sName = "Position2  " ; if(!OM.DevOptn.bUseLsrPst2){ Value[miLSR_TFrt][pvLSR_TFrtPos2 ].iType = vtHide ; }
    Value[miLSR_TFrt][pvLSR_TFrtPos3     ].sName = "Position3  " ; if(!OM.DevOptn.bUseLsrPst3){ Value[miLSR_TFrt][pvLSR_TFrtPos3 ].iType = vtHide ; }
    Value[miLSR_TFrt][pvLSR_TFrtPos4     ].sName = "Position4  " ; if(!OM.DevOptn.bUseLsrPst4){ Value[miLSR_TFrt][pvLSR_TFrtPos4 ].iType = vtHide ; }
    Value[miLSR_TFrt][pvLSR_TFrtPos5     ].sName = "Position5  " ; if(!OM.DevOptn.bUseLsrPst5){ Value[miLSR_TFrt][pvLSR_TFrtPos5 ].iType = vtHide ; }
    Value[miLSR_TFrt][pvLSR_TFrtPlace    ].sName = "Place      " ;

    Value[miLSR_TLer][pvLSR_TLerWait     ].sName = "Wait       " ;
    Value[miLSR_TLer][pvLSR_TLerPos1     ].sName = "Position1  " ; if(!OM.DevOptn.bUseLsrPst1){ Value[miLSR_TLer][pvLSR_TLerPos1 ].iType = vtHide ; }
    Value[miLSR_TLer][pvLSR_TLerPos2     ].sName = "Position2  " ; if(!OM.DevOptn.bUseLsrPst2){ Value[miLSR_TLer][pvLSR_TLerPos2 ].iType = vtHide ; }
    Value[miLSR_TLer][pvLSR_TLerPos3     ].sName = "Position3  " ; if(!OM.DevOptn.bUseLsrPst3){ Value[miLSR_TLer][pvLSR_TLerPos3 ].iType = vtHide ; }
    Value[miLSR_TLer][pvLSR_TLerPos4     ].sName = "Position4  " ; if(!OM.DevOptn.bUseLsrPst4){ Value[miLSR_TLer][pvLSR_TLerPos4 ].iType = vtHide ; }
    Value[miLSR_TLer][pvLSR_TLerPos5     ].sName = "Position5  " ; if(!OM.DevOptn.bUseLsrPst5){ Value[miLSR_TLer][pvLSR_TLerPos5 ].iType = vtHide ; }
    Value[miLSR_TLer][pvLSR_TLerPlace    ].sName = "Place      " ;
      ...
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
    ...
    if(2 == GridInfo.iCol ) {
        ...
        if(GridInfo.iGrid == miFED_YFrt) FFD.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
        if(GridInfo.iGrid == miFED_YLer) LFD.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
        if(GridInfo.iGrid == miLSR_TFrt) FLS.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
        if(GridInfo.iGrid == miLSR_TLer) LLS.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
...
/*
   if(Key == VK_RETURN){
        ...
        m_pPstnList[GridInfo.iGrid] -> Repaint() ;                         F
   }

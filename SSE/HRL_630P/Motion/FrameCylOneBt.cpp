...
__fastcall TFraCylOneBt::~TFraCylOneBt()
{
    delete m_pBtImgFw ; m_pBtImgFw = NULL ;
    delete m_pBtImgBw ; m_pBtImgBw = NULL ;
...
void __fastcall TFraCylOneBt::FrameResize(TObject *Sender)
{
    SetSize();
}
//---------------------------------------------------------------------------

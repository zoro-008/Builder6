...
#define MAX_ARRAY_COL  100     //Default Col Size of Tray. X.
#define MAX_ARRAY_ROW  100    //Default Row Size of Tray. Y.

extern TColor     clStat   [MAX_CHIP_STAT];

typedef void (__closure*CallbackAray)(int _iCol ,int _iRow);
...
class CArray
{
    ...
    public:
        ...
        void __fastcall SetMaxColRow (int c,int r) {SetMaxRow(r);SetMaxCol(c);}
        void __fastcall SetMaxRow    (int r      ) {
            if(r<0            ) r = 0             ;
            if(r>MAX_ARRAY_ROW) r = MAX_ARRAY_ROW ;

            m_iMaxRow = r;
        }
        void __fastcall SetMaxCol    (int c      ) {
            if(c<0            ) c = 0             ;
            if(c>MAX_ARRAY_COL) c = MAX_ARRAY_COL ;
        ...
        //Loading Para.
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        void __fastcall Load(bool _bLoad , AnsiString _sPath , AnsiString _sIniPath , int _iNo);

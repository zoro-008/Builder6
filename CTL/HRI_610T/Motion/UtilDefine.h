...
enum EN_EO_CMD {
    eoDAT     = 0,   //마킹 데이터 변경 데이터 전송
    eoVAD        ,   //레이저 조사 위치 데이터 전송
    eoCHM        ,   //디바이스 변경 데이터 전송
    eoRDY        ,   //레이저 레디 신호 전송
...
enum EN_INPUT_ID {
    ...
    x005C = 92 , x092                    = 92 , //
    x005D = 93 , x093                    = 93 , //
    x005E = 94 , xLSC_Ready              = 94 , //
    x005F = 95 , xLSC_Progress           = 95 , //
...
enum EN_OUTPUT_ID  {
    ...
    y003B = 59 , y059                    = 59 , //y059
    y003C = 60 , y060                    = 60 , //y060
    y003D = 61 , y061                    = 61 , //y061
    y003E = 62 , y062                    = 62 , //y062
    y003F = 63 , yLSC_Start              = 63 , //y063

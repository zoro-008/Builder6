...
void COptionMan::LoadDevOptn(AnsiString _sDevName)
{
    ...
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "dHoleXCntrOfs      " , DevOptn.dHoleXCntrOfs    );
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "dHoleYCntrOfs      " , DevOptn.dHoleYCntrOfs    );
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "dHoleTCntrOfs      " , DevOptn.dHoleTCntrOfs    );

    UserINI.Load(sPath.c_str()  , "DevOptn"  , "dVSNXLSRCntrOfs    " , DevOptn.dVSNXLSRCntrOfs  );
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "dVSNYLSRCntrOfs    " , DevOptn.dVSNYLSRCntrOfs  );
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "dVSNTLSRCntrOfs    " , DevOptn.dVSNTLSRCntrOfs  );

    UserINI.Load(sPath.c_str()  , "DevOptn"  , "sSampleLotNo       " , DevOptn.sSampleLotNo     );
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "sSampleFormat      " , DevOptn.sSampleFormat    );

    UserINI.Load(sPath.c_str()  , "DevOptn"  , "bLSRTest           " , DevOptn.bLSRTest         );
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "dOriVsnDelay       " , DevOptn.dOriVsnDelay     );
...
void COptionMan::SaveDevOptn(AnsiString _sDevName)
{
    ...
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "dHoleXCntrOfs      " , DevOptn.dHoleXCntrOfs    );
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "dHoleYCntrOfs      " , DevOptn.dHoleYCntrOfs    );
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "dHoleTCntrOfs      " , DevOptn.dHoleTCntrOfs    );

    UserINI.Save(sPath.c_str()  , "DevOptn"  , "dVSNXLSRCntrOfs    " , DevOptn.dVSNXLSRCntrOfs  );
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "dVSNYLSRCntrOfs    " , DevOptn.dVSNYLSRCntrOfs  );
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "dVSNTLSRCntrOfs    " , DevOptn.dVSNTLSRCntrOfs  );

    UserINI.Save(sPath.c_str()  , "DevOptn"  , "sSampleLotNo       " , DevOptn.sSampleLotNo     );
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "sSampleFormat      " , DevOptn.sSampleFormat    );

    UserINI.Save(sPath.c_str()  , "DevOptn"  , "bLSRTest           " , DevOptn.bLSRTest         );

    UserINI.Save(sPath.c_str()  , "DevOptn"  , "dOriVsnDelay       " , DevOptn.dOriVsnDelay     );
...
void COptionMan::LoadMstOptn()
{
    ...
    //UserINI.Load(sPath.c_str()  , "MstOptn"  , "iMaxFontCnt        " , MstOptn.iMaxFontCnt         );

    UserINI.Load(sPath.c_str()  , "MstOptn"  , "dVsnLsrYCntrPos    " , MstOptn.dVsnLsrYCntrPos     );

    UserINI.Load(sPath.c_str()  , "MstOptn"  , "dLsrXOfs           " , MstOptn.dLsrXOfs            );
    UserINI.Load(sPath.c_str()  , "MstOptn"  , "dLsrYOfs           " , MstOptn.dLsrYOfs            );
    UserINI.Load(sPath.c_str()  , "MstOptn"  , "dLsrTOfs           " , MstOptn.dLsrTOfs            );
...
void COptionMan::SaveMstOptn()
{
    ...
    //UserINI.Save(sPath.c_str()  , "MstOptn"  , "iMaxFontCnt        " , MstOptn.iMaxFontCnt         );

    UserINI.Save(sPath.c_str()  , "MstOptn"  , "dVsnLsrYCntrPos    " , MstOptn.dVsnLsrYCntrPos     );

    UserINI.Save(sPath.c_str()  , "MstOptn"  , "dLsrXOfs           " , MstOptn.dLsrXOfs            );
    UserINI.Save(sPath.c_str()  , "MstOptn"  , "dLsrYOfs           " , MstOptn.dLsrYOfs            );
    UserINI.Save(sPath.c_str()  , "MstOptn"  , "dLsrTOfs           " , MstOptn.dLsrTOfs            );
}

...
bool CPreBuff::CycleOriVisn(void)
{
    ...
    switch (Step.iCycle) {
        ...
        case  11: if(!m_tmDelay.OnDelay(true, OM.DevOptn.dOriVsnDelay))return false;
        ...
        case  12: if(!IO_GetX(xVSC_OriBusy)) return false ;
                  IO_SetY(yVSC_OriStart , false);
                  Step.iCycle++;
                  return false ;

        case  13: if(IO_GetX(xVSC_OriBusy)) return false ; //Inspection End

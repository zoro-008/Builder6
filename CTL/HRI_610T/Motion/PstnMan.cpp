...
void CPstnMan::Init()
{
    ...
    Value[miLSR_YAlVs][pvLSR_YAlVsWait      ].sName = "Wait       " ;
    Value[miLSR_YAlVs][pvLSR_YAlVsWork      ].sName = "Work       " ;
    Value[miLSR_YAlVs][pvLSR_YAlVsCal       ].sName = "Cal        " ;

    Value[miRAL_YCvsn][pvRAL_YCvsnWait      ].sName = "Wait       " ;
    Value[miRAL_YCvsn][pvRAL_YCvsnWork      ].sName = "Work       " ;

    Value[miVSN_XInsp][pvVSN_XInspWait      ].sName = "Wait       " ;
    Value[miVSN_XInsp][pvVSN_XInspWorkStt   ].sName = "WorkStart  " ;
    Value[miVSN_XInsp][pvVSN_XInspMskChange ].sName = "Mask Change" ;

    Value[miVSN_YInsp][pvVSN_YInspWait      ].sName = "Wait       " ;
    Value[miVSN_YInsp][pvVSN_YInspWorkStt   ].sName = "WorkStart  " ;
    Value[miVSN_YInsp][pvVSN_YInspMskChange ].sName = "Mask Change" ;

    Value[miPSB_XIndx][pvPSB_XIndxWait      ].sName = "Wait       " ;
    Value[miPSB_XIndx][pvPSB_XIndxRjct      ].sName = "Reject     " ;
    Value[miPSB_XIndx][pvPSB_XIndxOut       ].sName = "Out        " ;

    Value[miRAL_XLStp][pvRAL_XLStpWait      ].sName = "Wait       " ;
    Value[miRAL_XLStp][pvRAL_XLStpWork      ].sName = "Work       " ;

    Value[miRAL_XVStp][pvRAL_XVStpWait      ].sName = "Wait       " ;
    Value[miRAL_XVStp][pvRAL_XVStpWork      ].sName = "Work       " ;
    ...
    Value[miETC_Spare][pvSpare              ].sName = "Spare      " ;
      ...
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
    ...
    if(2 == GridInfo.iCol ) {
         ...
         if(GridInfo.iGrid == miLSR_YAlVs) LSR.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miRAL_YCvsn) RAL.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miVSN_XInsp) VSN.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miVSN_YInsp) VSN.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miPSB_XIndx) PSB.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miRAL_XLStp) RAL.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miRAL_XVStp) RAL.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);

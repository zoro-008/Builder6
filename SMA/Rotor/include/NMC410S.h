...
*/
	bool WINAPI nmc_get_ipaddress(short *nField0,short *nField1,short *nField2,short *nField3);

	// 장치의 IP 설정을 변경합니다. PC의 IP 설정하고는 관련이 없습니다.
	void WINAPI nmc_set_ipaddress(short dev_no,short nField0,short nField1,short nField2);
/*
...
//{
	...
	short WINAPI nmc_getmapdata(short dev_no, short axis,double *pMapdata,int *size);
//}
// 별도 기능 추가	
...
#define AND_FOR_END			12 // 반복 구간 끝
	...
	*/
	...
	short WINAPI nmc2_aptp_vel(short dev_no, short axis, long pulse, long start, long accdec, long max);
	short WINAPI nmc2_ptp_vel(short dev_no, short axis, long pulse, long start, long accdec, long max);
	...
	*/
	...
	short WINAPI nmc_get_pattern_cnt(short dev_no, unsigned short *count);
#ifdef __cplusplus
  	}
#endif
#endif

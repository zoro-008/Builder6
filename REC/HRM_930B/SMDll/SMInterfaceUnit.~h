...
typedef void (__stdcall * PMT_SetOverrideMaxSpeed)(int _iAxisNo, double _dOverSped);
typedef void (__stdcall * PMT_SetOverrideVel     )(int _iAxisNo, double _dOverSped);
typedef void (__stdcall * PMT_SetOverrideVelAtPos)(int _iAxisNo, double _dPos, double _dVel, double _dOverPos, double _dOverSped , bool _bCmd);
extern PMT_SetOverrideMaxSpeed MT_SetOverrideMaxSpeed ;
extern PMT_SetOverrideVel      MT_SetOverrideVel      ;
extern PMT_SetOverrideVelAtPos MT_SetOverrideVelAtPos ;

// JH_
typedef void (__stdcall * PMT_ContiWriteClear   )(int _iCoord);
typedef void (__stdcall * PMT_ContiSetAxisMap   )(int _iCoord, int _iAxisCnt, int * _ipAxisNo);
...
typedef int  (__stdcall * PMT_GetContCrntIdx    )(int _iCoord);
//typedef void (__stdcall * PMT_LineMove          )(int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpEndPos, double _dVel, double _dAcc, double _dDec);
typedef void (__stdcall * PMT_LineMove          )(int _iCoord, int *_ipAxisNo, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, int _iAxisCnt);
typedef void (__stdcall * PMT_CircleCenterMove  )(int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpCenterPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec);
typedef void (__stdcall * PMT_CirclePointMove   )(int _iCoord, int *_ipAxisNo, double *_dpMidPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, int _iArcCircle);
typedef void (__stdcall * PMT_CircleRadiusMove  )(int _iCoord, int *_ipAxisNo, double _dRadius, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir, DWORD _dwShortDistance);
typedef void (__stdcall * PMT_CircleAngleMove   )(int _iCoord, int *_ipAxisNo, double *_dCenterPos, double _dAngle, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir);

// JH_
extern PMT_ContiWriteClear    MT_WriteClear         ;
extern PMT_ContiSetAxisMap    MT_ContiSetAxisMap    ;
extern PMT_ContiSetAbsRelMode MT_ContiSetAbsRelMode ;
extern PMT_ContiBeginNode     MT_ContiBeginNode     ;
extern PMT_ContiEndNode       MT_ContiEndNode       ;
extern PMT_ContiStart         MT_ContiStart         ;
extern PMT_GetContCrntIdx     MT_GetContCrntIdx     ;
extern PMT_LineMove           MT_LineMove           ;
extern PMT_CircleCenterMove   MT_CircleCenterMove   ;
extern PMT_CirclePointMove    MT_CirclePointMove    ;
extern PMT_CircleRadiusMove   MT_CircleRadiusMove   ;
extern PMT_CircleAngleMove    MT_CircleAngleMove    ;

//겐트리 관련.
typedef void (__stdcall * PMT_SetGantryEnable     )(int _iMasterAxis , int _iSlaveAxis , int _iHomeUse , double _dSlaveOffset , double _dSlOffsetRange);
typedef void (__stdcall * PMT_SetGantryDisable    )(int _iMasterAxis , int _iSlaveAxis);
typedef void (__stdcall * PMT_SetHomeMethod       )(int _iAxis , int _iHomeDir , DWORD _dwHomeSignal , DWORD _dwUseZ , double _dHomeClrTime , double _dHomeOffset);
typedef void (__stdcall * PMT_SetHomeVel          )(int _iAxis , double _dVel1 , double _dVel2 , double _dVel3 , double _dLast ,double _dAcc1 , double _dAcc2);
typedef void (__stdcall * PMT_SetHomeStart        )(int _iAxis);
typedef bool (__stdcall * PMT_GetHomeResult       )(int _iAxis);

extern PMT_SetGantryEnable  MT_SetGantryEnable  ;
extern PMT_SetGantryDisable MT_SetGantryDisable ;
extern PMT_SetHomeMethod    MT_SetHomeMethod    ;
extern PMT_SetHomeVel       MT_SetHomeVel       ;
extern PMT_SetHomeStart     MT_SetHomeStart     ;
extern PMT_GetHomeResult    MT_GetHomeResult    ;

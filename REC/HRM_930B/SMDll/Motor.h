...
//          bool               bHomeWithNSnsr ; //홈센서로 홈을 잡을 것인지 -로 홈을 잡을 것인지.
    ...
    public:
        ...
        double GetManVel();
        double GetSlowVel();
        double GetPulseFromUnit(double _dUnit);
        ...
        void SetOverrideVelAtPos(double _dPos, double _dVel, double _dOverPos, double _dOverSped , bool _bCmd = false);

...
class CMotors
{
	...
	//Load Save Para Functions.
        ...
        bool FindEdgeStop   (int _iAxisNo ,double _dVel ,double _dAcc ,CAjinMotion::EN_FINDEDGE_TYPE _ftFindEdgeType);
        bool FindEdgeEmgStop(int _iAxisNo ,double _dVel ,double _dAcc ,CAjinMotion::EN_FINDEDGE_TYPE _ftFindEdgeType);
        ...
        double GetRptTickTime(int _iAxisNo);//Repeat Tick Time을 위해서 추가함.. JS

        void SetOverrideMaxSpeed(int _iAxisNo, double _dOverSped);
        void SetOverrideVel     (int _iAxisNo, double _dOverSped);
        void SetOverrideVelAtPos(int _iAxisNo, double _dPos, double _dVel, double _dOverPos, double _dOverSped , bool _bCmd = false);

        // 보간 구동을 위해 추가
        void ContiSetAxisMap   (int _iCoord, int _iAxisCnt, int *_ipAxisNo);
        void ContiSetAbsRelMode(int _iCoord, DWORD _dwAbsRelMode);
        void ContiBeginNode    (int _iCoord);
        void ContiEndNode      (int _iCoord);
        void ContiStart        (int _iCoord, DWORD _dwProfileset, int _iAngle);
        int  GetContCrntIdx    (int _iCoord);
        //void LineMove          (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpEndPos, double _dVel, double _dAcc, double _dDec);
        void LineMove          (int _iCoord, int *_ipAxisNo, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, int _iAxisCnt);
        void CircleCenterMove  (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpCenterPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir);
        void CirclePointMove   (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpMidPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, int _iArcCircle);
        void CircleRadiusMove  (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double _dRadius, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir, DWORD _dwShortDistance);
        void CircleAngleMove   (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dCenterPos, double _dAngle, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir);


        //겐트리.
        void SetGantryEnable    (int _iMasterAxis , int _iSlaveAxis , int _iHomeUse , double _dSlaveOffset , double _dSlOffsetRange);
        void SetGantryDisable   (int _iMasterAxis , int _iSlaveAxis);

        //겐트리용 홈함수.
        //void SetHomeMethod      (int _iAxis , int _iHomeDir , DWORD _dwHomeSignal , DWORD _dwUseZ , double _dHomeClrTime , double _dHomeOffset);
        //void SetHomeVel         (int _iAxis , double _dVel1 , double _dVel2 , double _dVel3 , double _dLast ,double _dAcc1 , double _dAcc2);
        void SetHomeStart       (int _iAxis);
        bool GetHomeResult      (int _iAxis);
};

    ...
    object Panel1: TPanel
      ...
      object cbToolID: TComboBox
        ...
        Items.Strings = (
          ...
          'LeftTool Height'
          'LeftTool UV'
          'LeftTool Rear Dispensor'
          'LeftTool Front Dispensor'
          'RightTool Transfer'
          'RightTool Vision'
          'RightTool Height'
          'Stage'
      ...
      object btVisibleSub: TButton
        Left = 296
        Top = 64
        Width = 73
        Height = 25
        Caption = 'Visible SubOn'
        TabOrder = 16
        OnClick = btVisibleSubClick
      end
      object btVisibleSubOff: TButton
        Left = 376
        Top = 64
        Width = 73
        Height = 25
        Caption = 'Visible SubOff'
        TabOrder = 17
        OnClick = btVisibleSubOffClick
      end
    end

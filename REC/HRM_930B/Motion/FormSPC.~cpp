...
void __fastcall TFrmSPC::FormShow(TObject *Sender)
{
    ...
    SPC.LOT.DispWorkDateList(sgLotDate) ;
...
void __fastcall TFrmSPC::sgLotDateClick(TObject *Sender)
{
    ...
    SPC.LOT.DispWorkList(sDate , sgLotInfo);
...
*/
void __fastcall TFrmSPC::btSaveCsvClick(TObject *Sender)
{
    if(!sdCSV->Execute()) return ;
    SPC.LOT.SaveWorkListCSV(sdCSV->FileName ) ;


}
//---------------------------------------------------------------------------

void __fastcall TFrmSPC::btSaveXlsClick(TObject *Sender)
{
    if(!sdXLS->Execute()) return ;
    SPC.LOT.SaveWorkListXLS(sdXLS->FileName ) ;
}
//---------------------------------------------------------------------------

...
#ifndef FormCadPosRttH
#define FormCadPosRttH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TFrmCadPosRtt : public TForm
{
...
public:		// User declarations
    ...
    __fastcall TFrmCadPosRtt(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFrmCadPosRtt *FrmCadPosRtt;
//---------------------------------------------------------------------------
#endif

...
class CGdi
{
    ...
    public:
        ...
        //Make Func 펜, 브러쉬 , 폰트등등 생성을 같이 하는 기본 함수들.
        void __stdcall Text     (double x, double y, char *str);
        void __stdcall Line     (double    x1, double    y1, double x2, double y2       );
        void __stdcall LineExt  (double    x1, double    y1, double x2, double y2       );
        void __stdcall Triangle (bool IsFill, double  x1, double  y1, double  x2, double y2, double x3, double y3);
        void __stdcall Rect     (bool IsFill, double  x1, double y1, double x2, double y2, double cs=0);
        void __stdcall Circle   (bool IsFill, double x1, double y1, double x2, double y2, double cs);
        void __stdcall TraceLine(TPoint *op, int cnt);
//        void __stdcall Move(double x , double y);


        void __stdcall Line     (TPoint p1, TPoint p2                       );

        void __stdcall LineExt  (TPoint p1, TPoint p2                       );
        void __stdcall LineCross(double    x , double    y ,                 double s);
        void __stdcall LineCross(TPoint p ,                            double s);
        void __stdcall LineX    (double    x , double    y ,                 double s);
        void __stdcall LineX    (TPoint p ,                            double s);
        void __stdcall LinePlus (double    x , double    y ,                 double s);
        void __stdcall LinePlus (TPoint p ,                            double s);
        void __stdcall LineAllow(double    x1, double    y1, double x2, double y2, double s=0);


        void __stdcall Triangle (bool IsFill, TPoint p1, TPoint p2, TPoint p3);


        void __stdcall RectNS   (bool IsFill, double  x1, double y1, double x2, double y2, double cs=0);
        void __stdcall Rect     (bool IsFill, TPoint p1, TPoint p2, double cs=0);
        void __stdcall Rect     (bool IsFill, TPoint p, double length, double cs=0);
        void __stdcall Rect     (bool IsFill, RECT r , double cs=0);
        void __stdcall Rect     (bool IsFill, TRect r , double cs=0);
        void __stdcall RectPoint(bool IsFill, double  x1, double y1, double x2, double y2, double cs=0, COLORREF pencolor=clAqua, double pensize=1, COLORREF ptcolor=clFuchsia, double ptsize=4);
        void __stdcall RectPoint(bool IsFill, RECT r ,                         double cs=0, COLORREF pencolor=clAqua, double pensize=1, COLORREF ptcolor=clFuchsia, double ptsize=4);


        void __stdcall Circle(bool IsFill, TPoint p1, TPoint p2, double cs);
        void __stdcall Circle(bool IsFill, RECT r, double cs);

        void __stdcall Circle(bool IsFill, double    x, double y, double r, double cs);
        void __stdcall Circle(bool IsFill, TPoint p,        double r, double cs);



        void  __stdcall Pixel(double x, double y, COLORREF color);
        void  __stdcall Pixel(TPoint p, COLORREF color);
        double __stdcall PixelXSize(double pixel);
        double __stdcall PixelYSize(double pixel);

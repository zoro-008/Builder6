...
/************************************************************************/
void __stdcall undistorted_to_distorted_image_coord (Xfu, Yfu, Xfd, Yfd)
    double    Xfu,
              Yfu,
             *Xfd,
             *Yfd;
...
/************************************************************************/
void __stdcall distorted_to_undistorted_image_coord (Xfd, Yfd, Xfu, Yfu)
    double    Xfd,
              Yfd,
             *Xfu,
             *Yfu;
...
\***********************************************************************/
void __stdcall world_coord_to_image_coord (xw, yw, zw, Xf, Yf)
    double    xw,
              yw,
              zw,
             *Xf,
...
\***********************************************************************/
void __stdcall image_coord_to_world_coord (Xfd, Yfd, zw, xw, yw)
    double    Xfd,
              Yfd, 
              zw,
             *xw,

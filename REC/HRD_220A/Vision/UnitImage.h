...
class CImage{// : public IImage{
    protected : //Var.
        ...
        double          m_dScaleX    ;  //이미지 스케일X.
        double          m_dScaleY    ;  //이미지 스케일Y.

        double          m_dOffsetX   ;  //이미지 오프셑X.
        double          m_dOffsetY   ;  //이미지 오프셑Y.
    ...
    public :
        ...
        bool __stdcall CheckRangeOver(double _x , double _y) ;
        ...
        //(0,0) , (1,0) , (0,1) , (1,1) 네픽셀의 밝기와 double형 위치값을 입력
        unsigned char __stdcall GetSubPixel(double _x , double _y ) ; */

        bool __stdcall CImage::CheckRangeOver(int   _x , int   _y) { return (0>_x   || _x>=m_iWidth   || 0>_y   || _y>=m_iHeight  );}
        bool __stdcall CImage::CheckRangeOver(double _x , double _y) {
            return (1>_x || _x>m_iWidth -2 ||  //서브픽셀링 때문에
                    1>_y || _y>m_iHeight-2);}
        ...
        //스케일이 적용된 Pixel. 첨조만 성립.
        unsigned char __stdcall CImage::GetPixelSc (int _x , int _y ){ /*if(!m_pImage  || CheckRangeOver(_x/m_dScaleX,_y/m_dScaleY)) return 0 ;*/ return *(m_pImage  + (int)(_x/m_dScaleX + m_iMemWidth8 * _y/m_dScaleY)                                ); };   //픽셀밝기값을 얻어 온다.
        unsigned char __stdcall CImage::GetPixelScR(int _x , int _y ){ /*if(!m_pImageC || CheckRangeOver(_x/m_dScaleX,_y/m_dScaleY)) return 0 ;*/ return *(m_pImageC + (int)(_x/m_dScaleX + m_iMemWidth8 * _y/m_dScaleY) * m_iBitCnt/BYTE_BIT_COUNT + 2 ); };
        unsigned char __stdcall CImage::GetPixelScG(int _x , int _y ){ /*if(!m_pImageC || CheckRangeOver(_x/m_dScaleX,_y/m_dScaleY)) return 0 ;*/ return *(m_pImageC + (int)(_x/m_dScaleX + m_iMemWidth8 * _y/m_dScaleY) * m_iBitCnt/BYTE_BIT_COUNT + 1 ); };
        unsigned char __stdcall CImage::GetPixelScB(int _x , int _y ){ /*if(!m_pImageC || CheckRangeOver(_x/m_dScaleX,_y/m_dScaleY)) return 0 ;*/ return *(m_pImageC + (int)(_x/m_dScaleX + m_iMemWidth8 * _y/m_dScaleY) * m_iBitCnt/BYTE_BIT_COUNT     ); };
                                                                                                                                                                           
        //(0,0) , (1,0) , (0,1) , (1,1) 네픽셀의 밝기와 double형 위치값을 입력
        unsigned char __stdcall CImage::GetSubPixel(double _x , double _y ) {
        ...
        double __stdcall GetScaleX() ;
        double __stdcall GetScaleY() ;

        double __stdcall GetOffsetX() ;
        double __stdcall GetOffsetY() ;
    ...
    public :
        ...
        void __stdcall operator = (CImage * _pImg)
        {
        ...
        void __stdcall Rotate   (TRect _tRect , double _dAngle);
        void __stdcall Trim     (TRect _tRect , CImage * _tDstImg);
        void __stdcall TrimScale(TRect _tRect , CImage * _tDstImg , double _dScale);
    ...
    public:
        ...
        bool __stdcall SetPoint (double * _dX , double * _dY , int _iMargin = 0 );

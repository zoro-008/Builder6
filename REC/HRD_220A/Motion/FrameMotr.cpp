...
bool TFraMotr::CheckSafe(int _iId)
{
    ...
    if(_iId == (int)miIDX_XIndxF){}
    if(_iId == (int)miIDX_XIndxR){}
    if(_iId == (int)miDSP_XDispr){}
    if(_iId == (int)miDSP_YDispr){}
    if(_iId == (int)miPCK_YPickr){}
    if(_iId == (int)miPCK_ZPickr){}
    if(_iId == (int)miPRI_XIndxF){}
    if(_iId == (int)miPRI_XIndxR){}
    if(_iId == (int)miDSP_ZDispr){}
    if(_iId == (int)miSTG_TStage){}
    if(_iId == (int)miSTG_XStage){}
    if(_iId == (int)miSTG_YStage){}
    if(_iId == (int)miPCK_XAlign){}
    if(_iId == (int)miPCK_YAlign){}
    if(_iId == (int)miULD_ZElevF){}
    if(_iId == (int)miULD_ZElevR){}
    if(_iId == (int)miSTG_ZStage){}

...
//        else if (_Frm->Components[i]->ClassNameIs("TPanel")) {
//            sComName = _Frm->Components[i]->ClassName();
//            sName    = ((TPanel*)_Frm->FindComponent(_Frm->Components[i]->Name))->Name     ;
//            sCaption = ((TPanel*)_Frm->FindComponent(_Frm->Components[i]->Name))->Caption  ;
//            if(sComName == "" || sName == "") continue ;
//            UserINI.Load(sPath.c_str()  , sComName  , sName , &sCaption);
//            ((TPanel*)_Frm->FindComponent(_Frm->Components[i]->Name))->Name    = sName     ;
//            ((TPanel*)_Frm->FindComponent(_Frm->Components[i]->Name))->Caption = sCaption  ;

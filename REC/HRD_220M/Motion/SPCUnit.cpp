...
const  EN_ARAY_ID DATA_ARAY = riDSP ;
...
{
         if(!DM.ARAY[riDSP].CheckAllStat(csNone)) return DM.ARAY[riDSP].GetLotNo() ;
    else if(!DM.ARAY[riJIG].CheckAllStat(csNone)) return DM.ARAY[riJIG].GetLotNo() ;
    else                                          return "";
}

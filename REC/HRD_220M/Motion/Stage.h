...
class CStage
{
	...
	void Reset     (); //리셋 버튼 눌렀을때 타는 함수.
        ...
        enum EN_SEQ_CYCLE {
            ...
            scZigPick    =  1 , // 시퀀스 싸이클 지그 픽 - 지그 집고 히터존까지 가는 파트
            scDispenser  =  2 , // 시퀀스 싸이클 디스펜서 - 액 뿌리는 파트 전체
            scPlace      =  3 , // 시퀀스 싸이클 지그 플레이스 - 히터존부터 ~ ???
            MAX_SEQ_CYCLE
        };
        ...
        void   InitCycleName(){
            ...
            m_sCycleName[scZigPick   ]="ZigPick  ";
            m_sCycleName[scDispenser ]="Dispenser";

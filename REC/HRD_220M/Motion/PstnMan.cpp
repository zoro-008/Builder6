...
void CPstnMan::Init()
{
    ...
    Value[miDSP_XDsps][pvDSP_XIndxWait     ].sName = "Wait     " ;
    Value[miDSP_XDsps][pvDSP_XIndxWorkStt  ].sName = "WorkStt  " ;
    Value[miDSP_XDsps][pvDSP_XIndxEnd      ].sName = "End      " ;

    Value[miSTG_ZPick][pvSTG_ZPickWait     ].sName = "Wait     " ;
    Value[miSTG_ZPick][pvSTG_ZPickJIG      ].sName = "JIG      " ;
    Value[miSTG_ZPick][pvSTG_ZPickWork     ].sName = "Work     " ;
    Value[miSTG_ZPick][pvSTG_ZPickPlace    ].sName = "Place    " ;
      ...
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
    ...
    if(2 == GridInfo.iCol ) {
         ...
         if(GridInfo.iGrid == miDSP_XDsps) ; JIP.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);  //JS 수정;
         if(GridInfo.iGrid == miSTG_ZPick) ; JIP.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
    }

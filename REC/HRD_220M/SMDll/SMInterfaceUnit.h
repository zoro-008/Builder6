...
typedef void (__stdcall * PSpeaceDown   )();
...
typedef void (__stdcall * PMT_SetSubHome)(int _iAxisNo , bool _bOn); //Start Home Cycle for Click Event.
...
extern PMT_SetSubHome MT_SetSubHome ;

...
//            EM_SetErr(eiPRB_Unknown) ;
        if ( IO_GetX(xPRB_3Pkg) && !OM.CmnOptn.bDryRun && DM.ARAY[riPR1].CheckAllStat(csNone) && DM.ARAY[riPR2].CheckAllStat(csNone)) EM_SetErr(eiPRB_Unknown) ;
    ...
    switch (Step.iToStart) {
        ...
        case 10: IO_SetY(yETC_BlowerAC,false);
                 if(DM.ARAY[riPR1].CheckAllStat(csNone)&&
                    DM.ARAY[riPR2].CheckAllStat(csNone))  MoveActr(aiPRB_Cmp , ccBwd);
                 Step.iToStart ++ ;
                 return false ;

        case 11: if(DM.ARAY[riPR1].CheckAllStat(csNone)&&
                    DM.ARAY[riPR2].CheckAllStat(csNone)&& !MoveActr(aiPRB_Cmp , ccBwd)) return false ;

                 if(DM.ARAY[riPR1].CheckAllStat(csNone)&&
                    DM.ARAY[riPR2].CheckAllStat(csNone))  MoveMotr(miPRB_XCmp , piPRB_XWait);

                 Step.iToStart++;
                 return false ;

        case 12: if(DM.ARAY[riPR1].CheckAllStat(csNone)&&
                    DM.ARAY[riPR2].CheckAllStat(csNone)&& !MoveMotr(miPRB_XCmp , piPRB_XWait)) return false ;

...
{
	unsigned short crc;
//	char babo[10] = {0x01, 0x04, 0x00, 0x00, 0x00, 0x02};
	char babo[10] = {0x02, 0x04, 0x02, 0x00, 0x00, 0x00, 0x00};

	crc = CRC16( (unsigned char*)babo, 5 );
	printf("\nHi,Lo Table : '%s'(%04X)\n", babo, crc);

	crc = CRC16_0( (unsigned char*)babo, 5 );
	printf("16 bit Table = '%s'(%04X)\n", babo, crc);

	crc = CRC16_1( (unsigned char*)babo, 5 );
	printf("CRC16 = '%s'(%04X)\n", babo, crc);

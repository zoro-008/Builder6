...
enum EN_OUTPUT_ID  {
    yETC_StartSw        =  0 , //
    yETC_StopSw         =  1 , //
    yETC_Light          =  2 , //  라이트는 도어 센서가 아닐 떄 들어와야함
    yETC_CoverUpDn      =  3 , //
    yETC_HeaterDnUp     =  4 , //
    y005                =  5 , //
    y006                =  6 , //
...
enum EN_INPUT_ID {
    ...
    xETC_StopSw         =  1 , //
    xETC_HomeSw         =  2 , //
    xETC_CoolingSw      =  3 , //  쿨링이 들어오면 실린더 벌리기
    xETC_Emergency      =  4 , //
    xETC_DoorSensor     =  5 , //
    xETC_CoverUp        =  6 , //
    xETC_HeaterDn       =  7 , //
...
__published:	// IDE-managed Components
    ...
    TBitBtn *btMotor1Sv;
        ...
        TLabel *Label35;
        TLabel *Label36;
        TCheckBox *cbUseOVSave;
        TMemo *mmTemp;
        TLabel *lbAngleTime;
        TLabel *Label38;
        TEdit *edShakeAcc;
        TLabel *Label37;
        TCheckBox *cbUsedCoverSEQ;
        TLabel *Label39;
        TEdit *edShakeSpeed;
...
//    void __fastcall LaserPosition1(TObject *Sender);
    ...
    void __fastcall btHeatCalClick(TObject *Sender);
        ...
        void __fastcall tmSaveBmpAviTimer(TObject *Sender);
        void __fastcall btSEQ1CycleClick(TObject *Sender);
        void __fastcall Panel_PulseXDblClick(TObject *Sender);
        void __fastcall Panel_PulseYDblClick(TObject *Sender);
        void __fastcall BitBtn2Click(TObject *Sender);
        void __fastcall BitBtn3Click(TObject *Sender);
        void __fastcall tmSeqTimer(TObject *Sender);
        void __fastcall btSeqReturnClick(TObject *Sender);
...
//    int  m_iMsgCnt3;
    ...
    bool m_bStop;
    bool m_bLiveCam ;
    bool m_bUseOVSave ; // OceanView Save
    bool m_bUsedCoverSEQ ; // Used Cover SEQ
...
//        MESSAGE_HANDLER(UM_EVN_RXCHAR_PB3  , TMessage, Heat3Ch )
   ...
   void __fastcall SeqStart  ();
   void __fastcall SeqStop   ();
   void __fastcall SeqHome   ();
   void __fastcall SeqCooling();

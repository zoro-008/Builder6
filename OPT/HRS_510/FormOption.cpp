...
void __fastcall TFrmOption::UpdateComOptn(bool _bToTable)
{
    if (_bToTable == toTabl) {
        ...
        edRezeroTrayCnt     -> Text    = OM.CmnOptn.iRezeroTrayCnt   ;
        ...
        cbNotUseTool1 -> Checked = OM.CmnOptn.bNotUseTool1 ;
        cbNotUseTool2 -> Checked = OM.CmnOptn.bNotUseTool2 ;
        cbNotUseTool3 -> Checked = OM.CmnOptn.bNotUseTool3 ;
        ...
        OM.CmnOptn.iRezeroTrayCnt     = edRezeroTrayCnt     -> Text.ToIntDef(0);
        ...
        OM.CmnOptn.bNotUseTool1 = cbNotUseTool1 -> Checked ;
        OM.CmnOptn.bNotUseTool2 = cbNotUseTool2 -> Checked ;
        OM.CmnOptn.bNotUseTool3 = cbNotUseTool3 -> Checked ;

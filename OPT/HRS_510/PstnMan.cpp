...
CPstnMan::CPstnMan()
{
    ...
    Value[miLDR_Z][pvLDR_ZWait      ].sName = "Wait      " ;
    Value[miLDR_Z][pvLDR_ZTop       ].sName = "Top       " ;
    Value[miLDR_Z][pvLDR_ZSparate   ].sName = "Separate  " ;

    Value[miPCK_Y][pvPCK_YWait      ].sName = "Wait      " ;
    Value[miPCK_Y][pvPCK_YPickStart ].sName = "PickStt   " ;
    Value[miPCK_Y][pvPCK_YPlce      ].sName = "Place     " ;
    Value[miPCK_Y][pvPCK_YZig       ].sName = "Zig       " ;

    Value[miRAL_X][pvRAL_XWait      ].sName = "Wait      " ;
    Value[miRAL_X][pvRAL_XGet       ].sName = "Get       " ;
    Value[miRAL_X][pvRAL_XWorkIn    ].sName = "Work In   " ;
    Value[miRAL_X][pvRAL_XWorkStart ].sName = "Work Stt  " ;
    Value[miRAL_X][pvRAL_XOut       ].sName = "Work Out  " ;

    Value[miSRT_X][pvSRT_XWait      ].sName = "Wait      " ;
    Value[miSRT_X][pvSRT_XPick      ].sName = "Pick      " ;
    Value[miSRT_X][pvSRT_XBin0      ].sName = "Bin 0     " ;
    Value[miSRT_X][poSRT_XBinPtch   ].sName = "Bin Pitch " ; Value[miSRT_X][poSRT_XBinPtch ].iType = vtOffset     ;
    Value[miSRT_X][poSRT_XSrtPtch   ].sName = "Sort Pitch" ; Value[miSRT_X][poSRT_XSrtPtch ].iType = vtOffset     ;
      ...
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
    ...
    if(2 == GridInfo.iCol ) {
         ...
         if(GridInfo.iGrid == miLDR_Z) LDR.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miPCK_Y) PCK.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miRAL_X) RAL.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miSRT_X) SRT.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow,0);
    }

...
//    iLen = Rs232_H->ReadData(_cbInQue, RcvBuff);
    ...
    if(!sRcvMsg.Pos("\r\n"  )) return ;
    Trace("procCom1",sRcvMsg.c_str());
    sTemp = sRcvMsg.SubString(sRcvMsg.Pos("ID001,")+6,2) + ".";

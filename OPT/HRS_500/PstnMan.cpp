...
CPstnMan::CPstnMan()
{
    ...
    Value[miSRT_X][pvSRT_XLBn9      ].sName = "Left Bin 9" ;
    Value[miSRT_X][poSRT_XPtch      ].sName = "Pitch     " ;
    Value[miSRT_X][poSRT_XPtch      ].iType = vtOffset     ;
      ...
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
    ...
    if(2 == GridInfo.iCol ) {
         ...
         if(GridInfo.iGrid == miSRT_X) SRT.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
    }

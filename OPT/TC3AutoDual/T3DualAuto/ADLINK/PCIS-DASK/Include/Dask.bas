...
Declare Function DIO_GetCOSLatchData32 Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, CosLData As Long) As Integer
Declare Function DIO_GetCOSLatchDataInt32 Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, CosLData As Long) As Integer

...
LPARAM lParam;
{
  ...
  switch(message) {
    ...
    case WM_PAINT:
        ...
        TextOut(hDC, 5, 20, "PCI7250   ", 9);      
        SetTextColor(hDC,RGB(255,255,255));  
        SetBkColor(hDC, RGB(0, 0, 255)); 
        TextOut(hDC, 5, 130, "PCI7251#1", 9);
		SetBkColor(hDC, RGB(0, 0, 255)); 
        TextOut(hDC, 5, 240, "PCI7251#2", 9);
        SetBkColor(hDC, RGB(0, 0, 255)); 
        TextOut(hDC, 5, 350, "PCI7251#3", 9);

...
int             nCmdShow;
{
    ...
    hInst = hInstance;
    hWnd = CreateWindow("IntClass", "PCI-7433 Interrupt Sample (INT1)", WS_OVERLAPPEDWINDOW,
...
LPARAM lParam;
{
    ...
    switch(message) {
        case WM_CREATE:
             ...
             DIO_SetDualInterrupt(card, INT1_EXT_SIGNAL, INT2_DISABLE, hEvent);
        ...
        case WM_PAINT:
             ...
             TextOut(hDC, 20, 60, "by external signal from DI bit-0.", 33);

...
U32 inputA[4], inputB[4], inputC[4] , inputD[4];
U32 outputA[4],outputB[4],outputC[4] ,outputD[4];
U32 oldinputA[4],  oldinputB[4], oldinputC[4] , oldinputD[4]; 
U32 temp_output;

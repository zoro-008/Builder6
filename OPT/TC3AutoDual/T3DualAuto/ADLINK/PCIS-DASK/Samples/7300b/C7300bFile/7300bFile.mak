...
!MESSAGE 
!MESSAGE NMAKE /f "7300bFile.mak" CFG="7300File - Win32 Debug"
!MESSAGE 
...
ALL : "$(OUTDIR)\7300bFile.exe"

CLEAN : 
	-@erase "$(INTDIR)\7300bfile.obj"
	-@erase "$(OUTDIR)\7300bFile.exe"
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/7300bFile.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /incremental:no /pdb:"$(OUTDIR)/7300bFile.pdb" /machine:I386\
 /out:"$(OUTDIR)/7300bFile.exe" 
LINK32_OBJS= \
	"$(INTDIR)\7300bfile.obj"

"$(OUTDIR)\7300bFile.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\7300bFile.exe"
	-@erase "$(OUTDIR)\7300bFile.ilk"
	-@erase "$(OUTDIR)\7300bFile.pdb"
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib ..\..\..\lib\pci-dask.lib /nologo /subsystem:console\
 /incremental:yes /pdb:"$(OUTDIR)/7300bFile.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/7300bFile.exe" 
LINK32_OBJS= \
	"$(INTDIR)\7300bfile.obj"
...
"$(INTDIR)\7300bfile.obj" : $(SOURCE) $(DEP_CPP_7300B) "$(INTDIR)"

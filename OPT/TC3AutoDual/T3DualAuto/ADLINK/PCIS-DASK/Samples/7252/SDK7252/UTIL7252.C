/*;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;  Copyright (c) 1997-1999, ADLink Technology Inc.  All rights reserved.  ;;
;;                                                                         ;;
;;      File Name   :   Util7252.C                                         ;;
...
int nCmdShow;
{
  ...
  hInst = hInstance;
  hSampleMenu = LoadMenu(hInstance, "U7252Menu");
...
LPARAM lParam;
{
  ...
  switch(message) {
    ...
    case WM_PAINT:
        ...
        TextOut(hDC, output_pos[15].x+164, output_pos[15].y+16, "7                                 0", 35);
        SetBkColor(hDC, RGB(0, 255, 0));

...
int             nCmdShow;
{
    ...
    hInst = hInstance;
    hWnd = CreateWindow("IntClass", "PCI-7258 Interrupt Sample (INT1)", WS_OVERLAPPEDWINDOW,
...
LPARAM lParam;
{
    ...
    switch(message) {
        case WM_CREATE:
             ...
             err = DIO_SetDualInterrupt(card, INT1_EXT_SIGNAL, INT2_DISABLE, hEvent);
             hMainWnd = hWnd;

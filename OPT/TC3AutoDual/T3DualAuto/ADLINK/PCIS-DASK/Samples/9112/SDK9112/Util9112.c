...
LPSTR AD_Range[9]={"+/-10V","+/-5V","+/-2.5V","+/-1.25V","+/-0.625V","0-10V","0-5V","0-2.5V","0-1.25V"};
I16 range_value[9] = {AD_B_10_V, AD_B_5_V, AD_B_2_5_V, AD_B_1_25_V, AD_B_0_625_V, AD_U_10_V, AD_U_5_V, AD_U_2_5_V, AD_U_1_25_V};
...
LPARAM lParam;
{
  ...
  switch(message) {
    ...
    case WM_PAINT:
           ...
           TextOut(hDC,output_pos[13].x+90, output_pos[15].y+56," PCI-9112 ",9);

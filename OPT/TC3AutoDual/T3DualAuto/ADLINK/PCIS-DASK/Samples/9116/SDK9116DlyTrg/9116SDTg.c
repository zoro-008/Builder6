...
int nCmdShow;
{
  ...
  hWnd = CreateWindow("GenericWClass",
                      (LPCSTR)"PCI-9116 Single Buffered DMA with Delay Trigger Mode",
                      WS_OVERLAPPEDWINDOW,
                      CW_USEDEFAULT,
                      CW_USEDEFAULT,
                      520,
    ...
    case WM_COMMAND:
        switch(LOWORD(wParam)) {
           ...
           case IDC_START:
				...
				if(!ai_mode)				  
					AI_9116_Config(card,0,P9116_AI_DMA|P9116_TRGMOD_DELAY|(dl_mode?P9116_AI_DlyInSamples:P9116_AI_DlyInTimebase)|P9116_AI_ReTrigEn,65535,0,trgCount);
				else 
					AI_9116_Config(card,0,P9116_AI_INT|P9116_TRGMOD_DELAY|(dl_mode?P9116_AI_DlyInSamples:P9116_AI_DlyInTimebase)|P9116_AI_ReTrigEn,65535,0,trgCount);
                ...
                //err = AI_ContReadChannel (card, channel, range, ai_buf, trgCount*data_size, (F32)1, ASYNCH_OP);
				if(err !=0) {

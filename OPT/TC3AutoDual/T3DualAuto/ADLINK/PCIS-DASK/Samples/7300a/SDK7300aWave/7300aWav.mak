...
!MESSAGE 
!MESSAGE NMAKE /f "7300aWav.mak" CFG="7300Wav - Win32 Debug"
!MESSAGE 
...
ALL : "$(OUTDIR)\7300aWav.exe"

CLEAN : 
	-@erase "$(INTDIR)\7300awav.obj"
	-@erase "$(INTDIR)\7300aWav.res"
	-@erase "$(OUTDIR)\7300aWav.exe"
...
RSC_PROJ=/l 0x404 /fo"$(INTDIR)/7300aWav.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/7300aWav.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /incremental:no /pdb:"$(OUTDIR)/7300aWav.pdb" /machine:I386\
 /out:"$(OUTDIR)/7300aWav.exe" 
LINK32_OBJS= \
	"$(INTDIR)\7300awav.obj" \
	"$(INTDIR)\7300aWav.res"

"$(OUTDIR)\7300aWav.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\7300aWav.exe"
	-@erase "$(OUTDIR)\7300aWav.ilk"
	-@erase "$(OUTDIR)\7300aWav.pdb"
...
RSC_PROJ=/l 0x404 /fo"$(INTDIR)/7300aWav.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/7300aWav.bsc" 
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib ..\..\..\lib\Pci-dask.lib /nologo /subsystem:windows\
 /incremental:yes /pdb:"$(OUTDIR)/7300aWav.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/7300aWav.exe" 
LINK32_OBJS= \
	"$(INTDIR)\7300awav.obj" \
	"$(INTDIR)\7300aWav.res"
...
"$(INTDIR)\7300aWav.res" : $(SOURCE) "$(INTDIR)"
   $(RSC) $(RSC_PROJ) $(SOURCE)
...
"$(INTDIR)\7300awav.obj" : $(SOURCE) $(DEP_CPP_7300A) "$(INTDIR)"

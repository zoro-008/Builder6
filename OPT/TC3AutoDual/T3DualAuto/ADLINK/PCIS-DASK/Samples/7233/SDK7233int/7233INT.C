...
int             nCmdShow;
{
    ...
    hInst = hInstance;
    hWnd = CreateWindow("IntClass", "PCI-7233 Interrupt Sample (INT1)", WS_OVERLAPPEDWINDOW,
                        200, 100, 360, 270, NULL, NULL, hInstance, NULL);
...
LPARAM lParam;
{
    ...
    switch(message) {
        ...
        case WM_PAINT:
             ...
             TextOut(hDC, 20, 60, "by change of state of DI bit 0-15.", 34);

...
int int_count=0, int2_count=0, press_count=0;
...
LPARAM lParam;
{
    ...
    switch(message) {
        case WM_CREATE:
			 ...
			 DO_SimuWritePort(card, 2, out_data0);
			 //DO_WritePort(card, P7442_CH0, 0);			
			 //DO_WritePort(card, P7442_CH1, 0);
			 Sleep(1);
        ...
        case WM_PAINT:
             ...
             TextOut(hDC, 20, 65, "COS1 interrupt is generated by change of state of DI1 bit-0.", 59);
             ...
             switch(LOWORD(wParam)) {
               ...
               case IDC_OUTPUT:
				     ...
				     if(press_count%2 == 0){
						 ...
						 DO_SimuWritePort(card, 2, out_data1);
					 }
					 else{

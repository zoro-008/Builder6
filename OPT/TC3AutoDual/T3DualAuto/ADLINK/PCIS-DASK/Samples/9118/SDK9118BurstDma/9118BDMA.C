...
int nCmdShow;
{
  ...
  hWnd = CreateWindow("GenericWClass",
                      (LPCSTR)"9118 Autoscan DMA with Burst Mode",
                      WS_OVERLAPPEDWINDOW,
                      CW_USEDEFAULT,
                      CW_USEDEFAULT,
                      520,
  ...
  char s[50];
      switch (message) {
         case WM_INITDIALOG:
              ...
              wsprintf(n,"%d",burst_num);
              SetWindowText(GetDlgItem(hWnd,IDC_EDIT1),n);
              break;
         case WM_COMMAND:
              switch(LOWORD(wParam)) {
                ...
                case IDC_CHECK1:
                     ...
                     break;
                case IDOK:
                     burst_num = GetDlgItemInt(hWnd,IDC_EDIT1,NULL ,FALSE);
                     if (burst_num <=0) {
                         wsprintf(s, "Burst Number must be larger than 0");
         ...
         switch(LOWORD(wParam)) {
           ...
           case IDC_CHAN:
            ...
            case IDC_START:
                  ...
                  if(bcheck)
                      AI_9118_Config(card,P9118_AI_BiPolar|P9118_AI_SingEnded,P9118_AI_BurstModeEn|P9118_AI_SampleHold,burst_num,0);
                  else
                      AI_9118_Config(card,P9118_AI_BiPolar|P9118_AI_SingEnded,P9118_AI_BurstModeEn,burst_num,0);
                  ...
                  for (i=0;i<data_size;i++) {
                   ...
                   adinput = adinput >> 4;
                   adinput=io_pos[0].y+173-(175*(long)adinput)/4095;

...
int nCmdShow;
{
  ...
  hWnd = CreateWindow("GenericWClass",
                      (LPCSTR)"PCI-9118 Double Buffered DMA with Post Trigger",
                      WS_OVERLAPPEDWINDOW,
                      CW_USEDEFAULT,
                      CW_USEDEFAULT,
                      520,
    ...
    case WM_COMMAND:
        switch(LOWORD(wParam)) {
           ...
           case IDC_START:
                ...
                fstop =0;
                if ((err=AI_9118_Config(card,P9118_AI_BiPolar|P9118_AI_SingEnded,P9118_AI_DtrgPositive|P9118_AI_EtrgPositive|P9118_AI_PostTrgEn,0,postCount))!= NoError) {
                ...
                if ((err=AI_ContReadChannel(card, channel, AD_B_5_V, ai_buf, data_size, (F32)sample_rate, ASYNCH_OP)) != NoError) {

// CxSkinButtonExx.cpp : implementation file
/** 15/03/2001 v1.00
 ...
 ** 28/3/2002 v1.411 , by yangju kim.
 * - Append mouse click event enable/disable routine
 */
...
/////////////////////////////////////////////////////////////////////////////
// CxSkinButtonExx
CxSkinButtonExx::CxSkinButtonExx()
{
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CxSkinButtonExx, CButton)
	//{{AFX_MSG_MAP(CxSkinButtonExx)
	ON_WM_ERASEBKGND()
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
...
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
// CxSkinButtonExx message handlers
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonExx::PreSubclassWindow() 
{
...
/////////////////////////////////////////////////////////////////////////////
BOOL CxSkinButtonExx::OnEraseBkgnd(CDC* pDC) 
{	return 1; }	// doesn't erase the button background
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonExx::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
...
/////////////////////////////////////////////////////////////////////////////
int CxSkinButtonExx::GetBitmapWidth (HBITMAP hBitmap)
{ BITMAP bm; GetObject(hBitmap,sizeof(BITMAP),(PSTR)&bm); return bm.bmWidth;}
/////////////////////////////////////////////////////////////////////////////
int CxSkinButtonExx::GetBitmapHeight (HBITMAP hBitmap)
{ BITMAP bm; GetObject(hBitmap,sizeof(BITMAP),(PSTR)&bm); return bm.bmHeight;}
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonExx::DrawBitmap(CDC* dc, HBITMAP hbmp, RECT r, int DrawMode)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonExx::FillWithBitmap(CDC* dc, HBITMAP hbmp, RECT r)
{
	if(!hbmp) return;
	CDC memdc;
...
/*//////////////////////////////////////////////////////////////////////////
//ex) setskin(norm,down,over,disabled,0,mask,0,0,0);
////////////////////////////////////////////////////////////////////////////*/
void CxSkinButtonExx::SetSkin(UINT normal,UINT down,UINT over,UINT disabled, UINT focus,UINT mask,
...
/////////////////////////////////////////////////////////////////////////////
HRGN CxSkinButtonExx::CreateRgnFromBitmap(HBITMAP hBmp, COLORREF color)
{
	if (!hBmp) return NULL;
...
//		if(dcBmp.GetPixel(j,bm.bmHeight-i-1)!=RGB(255,255,255))
...
/////////////////////////////////////////////////////////////////////////////
COLORREF CxSkinButtonExx::SetTextColor(COLORREF new_color)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonExx::SetToolTipText(CString s)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonExx::RelayEvent(UINT message, WPARAM wParam, LPARAM lParam)
{
...
//
//---------------------------------------------------------
void CxSkinButtonExx::OnLButtonDblClk(UINT flags, CPoint point) 
{
	if(m_nMouseDownStatus==0) 
...
//
//---------------------------------------------------------
void CxSkinButtonExx::OnLButtonDown(UINT nFlags, CPoint point)
{
	...
	if(m_nMouseDownStatus==0) {
		...
		if(this->GetSafeHwnd()==m_pView->m_wMoveArea.m_pwButton[0]->GetSafeHwnd())
		{
...
//
//---------------------------------------------------------
void CxSkinButtonExx::OnLButtonUp(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: up\n", ::GetTickCount());
	if(m_nMouseDownStatus==0) {
...
//
//---------------------------------------------------------
void CxSkinButtonExx::OnMouseMove(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: Mouse\n", ::GetTickCount());
...
//
//---------------------------------------------------------
LRESULT CxSkinButtonExx::OnMouseLeave(WPARAM, LPARAM)
{
    ASSERT (m_tracking);
    //TRACE("* Mouse leave\n");
    m_tracking = false;
...
//
//---------------------------------------------------------
void CxSkinButtonExx::OnKillFocus(CWnd *new_wnd)
{
...
//
//---------------------------------------------------------
BOOL CxSkinButtonExx::OnClicked() 
{
    if (::GetCapture() == m_hWnd) {
        ::ReleaseCapture();
        ASSERT (!m_tracking);
...
//
//---------------------------------------------------------
LRESULT CxSkinButtonExx::OnRadioInfo(WPARAM wparam, LPARAM)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonExx::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
//
//---------------------------------------------------------
LRESULT CxSkinButtonExx::OnBMSetCheck(WPARAM wparam, LPARAM)
{
	m_Checked=wparam!=0;
	switch (m_Style)
	{
...
/////////////////////////////////////////////////////////////////////////////
LRESULT CxSkinButtonExx::OnBMGetCheck(WPARAM wparam, LPARAM)

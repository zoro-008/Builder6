// CxSkinButtonEx.cpp : implementation file
/** 15/03/2001 v1.00
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CxSkinButtonEx, CButton)
	//{{AFX_MSG_MAP(CxSkinButtonEx)
	ON_WM_ERASEBKGND()
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
...
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
// CxSkinButtonEx message handlers
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonEx::PreSubclassWindow() 
{
...
/////////////////////////////////////////////////////////////////////////////
BOOL CxSkinButtonEx::OnEraseBkgnd(CDC* pDC) 
{	return 1; }	// doesn't erase the button background
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonEx::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
...
/////////////////////////////////////////////////////////////////////////////
int CxSkinButtonEx::GetBitmapWidth (HBITMAP hBitmap)
{ BITMAP bm; GetObject(hBitmap,sizeof(BITMAP),(PSTR)&bm); return bm.bmWidth;}
/////////////////////////////////////////////////////////////////////////////
int CxSkinButtonEx::GetBitmapHeight (HBITMAP hBitmap)
{ BITMAP bm; GetObject(hBitmap,sizeof(BITMAP),(PSTR)&bm); return bm.bmHeight;}
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonEx::DrawBitmap(CDC* dc, HBITMAP hbmp, RECT r, int DrawMode)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonEx::FillWithBitmap(CDC* dc, HBITMAP hbmp, RECT r)
{
	if(!hbmp) return;
	CDC memdc;
...
////////////////////////////////////////////////////////////////////////////*/
void CxSkinButtonEx::SetSkin(UINT normal,UINT down,UINT over,UINT disabled, UINT focus,UINT mask,
...
/////////////////////////////////////////////////////////////////////////////
HRGN CxSkinButtonEx::CreateRgnFromBitmap(HBITMAP hBmp, COLORREF color)
{
	if (!hBmp) return NULL;
...
/////////////////////////////////////////////////////////////////////////////
COLORREF CxSkinButtonEx::SetTextColor(COLORREF new_color)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonEx::SetToolTipText(CString s)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonEx::RelayEvent(UINT message, WPARAM wParam, LPARAM lParam)
{
...
//
//---------------------------------------------------------
void CxSkinButtonEx::OnLButtonDblClk(UINT flags, CPoint point) 
{
...
//
//---------------------------------------------------------
void CxSkinButtonEx::OnLButtonDown(UINT nFlags, CPoint point)
{
...
//
//---------------------------------------------------------
void CxSkinButtonEx::OnLButtonUp(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: up\n", ::GetTickCount());
	if(m_nMouseDownStatus==0) {
...
//
//---------------------------------------------------------
void CxSkinButtonEx::OnMouseMove(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: Mouse\n", ::GetTickCount());
...
//
//---------------------------------------------------------
LRESULT CxSkinButtonEx::OnMouseLeave(WPARAM, LPARAM)
{
    ASSERT (m_tracking);
    //TRACE("* Mouse leave\n");
    m_tracking = false;
...
//
//---------------------------------------------------------
void CxSkinButtonEx::OnKillFocus(CWnd *new_wnd)
{
...
//
//---------------------------------------------------------
LRESULT CxSkinButtonEx::OnRadioInfo(WPARAM wparam, LPARAM)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxSkinButtonEx::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
//
//---------------------------------------------------------
LRESULT CxSkinButtonEx::OnBMSetCheck(WPARAM wparam, LPARAM)
{
	m_Checked=wparam!=0;
	switch (m_Style)
	{
...
/////////////////////////////////////////////////////////////////////////////
LRESULT CxSkinButtonEx::OnBMGetCheck(WPARAM wparam, LPARAM)

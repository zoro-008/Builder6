...
//    if(MAX_MOTR != MT_GetMotorCnt()) {ShowMessageT("Motor Count is wrong");}
    ...
    ValMtr[tmMOTOR0 ].sName = "Loader Y"          ;
    ValMtr[tmMOTOR1 ].sName = "Loader Z"          ;
    ...
    ValMtr[tmMOTOR7 ].sName = "Sort YTop"         ;
    ValMtr[tmMOTOR8 ].sName = "Sort YBottom"      ;
    ValMtr[tmMOTOR9 ].sName = "Reject XBottom"    ;

    ValMtr[tmMOTOR10].sName = "UnLoader Y"        ;
    ValMtr[tmMOTOR11].sName = "UnLoader Z"        ;

    //Motor Index
    ValMtr[tmMOTOR0 ].iMtId = (int)miLD1_YCmp     ;
    ValMtr[tmMOTOR1 ].iMtId = (int)miLD1_ZCmp     ;
    ...
    ValMtr[tmMOTOR7 ].iMtId = (int)miSTL_YTop    ;
    ValMtr[tmMOTOR8 ].iMtId = (int)miSTL_YBtm    ;
    ValMtr[tmMOTOR9 ].iMtId = (int)miREJ_XBtm    ;
    ValMtr[tmMOTOR10].iMtId = (int)miULD_YCmp    ;
    ValMtr[tmMOTOR11].iMtId = (int)miULD_ZCmp    ;

    //Motor Jog Disp Type
    ValMtr[tmMOTOR0 ].iType = mdtBackFor_X ;
    ValMtr[tmMOTOR1 ].iType = mdtUpDown    ;
    ...
    ValMtr[tmMOTOR7 ].iType = mdtBackFor_Y ;
    ValMtr[tmMOTOR8 ].iType = mdtBackFor_Y ;
    ValMtr[tmMOTOR9 ].iType = mdtBackFor_X ;
    ValMtr[tmMOTOR10].iType = mdtBackFor_X ;
    ValMtr[tmMOTOR11].iType = mdtUpDown    ;

    //Motor Tab Count
    ValTab[mtiLDR  ].iMtCnt = 2 ;
    ValTab[mtiRAIL ].iMtCnt = 3 ;
    ValTab[mtiPROBE].iMtCnt = 2 ;
    ValTab[mtiSORT ].iMtCnt = 3 ;
    ValTab[mtiULD  ].iMtCnt = 2 ;

    //Motor Tab Name
    ValTab[mtiLDR  ].sName = "LDR"  ;
    ValTab[mtiRAIL ].sName = "RAIL" ;
    ValTab[mtiPROBE].sName = "PROBE";
    ValTab[mtiSORT ].sName = "SORT" ;
    ValTab[mtiULD  ].sName = "ULD"  ;

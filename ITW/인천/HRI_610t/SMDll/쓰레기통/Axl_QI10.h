...
//SUN Kye Won 2012.03.14
//모션 최하위 유닛으로 AJIN사의 구형인 QI 버젼의 랩핑 클래스
...
extern SAxlParaUi AxlParaUi ;
void MakeAxlUI      ();

//void SetArrange  (TControl * _ctCon , int _iCol , int _iRow);
void SetAxlArrange (TControl    * _pnPanel    , int _iCol , int _iRow);
...
class CAxlQI10
{
    public:
        ...
        struct SAxlPara{ //Board Level Direct Access AxlPara. (INI)
...
//          bool   bZphaActLevel ; //CFS20set_nend_limit_level // 역방향 리미트(-End limit)의 액티브레벨 설정
    ...
    protected:
        ...
        //Apply AXT Liblary Directly Access AxlPara
        void ApplyAxlPara ();
    ...
    public:
        ...
        //AxlParameter Memory Handling Fuctions.
        void SetAxlPara (SAxlPara &_AxlPara );
        void GetAxlPara (SAxlPara &_AxlPara );

	//Save AxlPara Functions.
        void Save();
        void Load();

        void UpdateAxlPara(bool _bToTable);

object FrmOption: TFrmOption
  ...
  object Panel3: TPanel
    ...
    object cbSkipOriVisn: TCheckBox
      Tag = 4
      Left = 9
      Top = 104
      Width = 238
    ...
    object cbSkipAlnVisn: TCheckBox
      Tag = 4
      Left = 9
      Top = 152
      Width = 238
    ...
    object rgMarkInsp: TRadioGroup
      Left = 16
      Top = 272
      Width = 201
      Height = 89
      Caption = 'Mark Inspection Option'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Arial'
    ...
    object cbFrstStrpOut: TCheckBox
      Tag = 4
      Left = 9
      Top = 176
      Width = 238
      Height = 22
      Caption = 'First Strip Out'
      Color = clScrollBar
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -16

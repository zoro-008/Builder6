...
//                             Fail
    */
    ...
    //btMan3_10 -> Caption = "[" + AnsiString(mcLSR_CycleAVsn   ) + "]" + (bKorean ? "얼라인 비젼 검사"  : "LSR Cycle AlgVisn" );  btMan3_10 -> Tag = (int)mcLSR_CycleAVsn    ; btMan3_10 -> Visible = true ;
...
void __fastcall TFrmOperation::tmUpdateTimer(TObject *Sender)
{
    ...
    */
    ...
    if(LTQ.GetLotCnt() == 0 && bAllArayNone){

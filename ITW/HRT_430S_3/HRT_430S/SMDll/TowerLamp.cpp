...
void __fastcall CTowerLamp::DisplayList(TStringGrid *Table)
{
    ...
    Table -> ColCount = 5  ;
        ...
        //Set Col.
    Table -> Cells[0][0] = "STATUS  " ;  Table -> ColWidths[0] = 130 ;
    Table -> Cells[1][0] = "RED     " ;  Table -> ColWidths[1] = 100 ;
    Table -> Cells[2][0] = "YELLOW  " ;  Table -> ColWidths[2] = 100 ;
    Table -> Cells[3][0] = "GREEN   " ;  Table -> ColWidths[3] = 100 ;
    Table -> Cells[4][0] = "SOUND   " ;  Table -> ColWidths[4] = 100 ;

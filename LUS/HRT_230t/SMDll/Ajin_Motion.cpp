...
void CAjinMotion::SetIntrptPos(double _dPos , PosCallbackFunc _pCallback)
{
    ...
    */
    AxmSetCommandData32Qi(m_iAxisNo,QiCNTC2Write,_dPos);
    /*
    전체 인터럽트 Enable
    */
    AxlInterruptEnable();
    ...
    해당축 인터럽트 Enable
    */
    AxmInterruptSetAxisEnable(m_iAxisNo, ENABLE);
    /*
    ...
    */
    AxmInterruptSetUserEnable(m_iAxisNo, 0, QIINTBANK1_7);
    /*
    인터럽트 발생시 호출될 컬백 함수 등록
    */
    AxmInterruptSetAxis(m_iAxisNo, NULL, NULL, _pCallback,NULL);

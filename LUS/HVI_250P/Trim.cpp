...
bool CWork::LotInfoAdd  ()
{
    ...
    if(OM.MstOptn.bGoodChipAdd) {
        LT.AddDayInfoWorkChip(m_iGoodCnt );
        LT.AddLotInfoWorkChip(m_iGoodCnt );
        OM.iTotalChip += m_iGoodCnt ;
        LT.AddDayInfoFailChip(iChipCnt - m_iGoodCnt);
        LT.AddLotInfoFailChip(iChipCnt - m_iGoodCnt);
    }
    else {
...
void CWork::Load(bool IsLoad)
{
    ...
    if(IsLoad) {
        ...
        UserINI.Load(sPath.c_str()  , m_sPartName.c_str()  , "m_iGoodCnt     " , m_iGoodCnt       );
        ...
        UserINI.Save(sPath.c_str()  , m_sPartName.c_str()  , "m_iGoodCnt     " , m_iGoodCnt       );
    }
}

...
//    if(LotNo == "") PushLotNo(tLotStartTime.FormatString("yyyy-mm-dd hh-nn-ss")) ;

//    LT.LotInfo.sLotNo     = LotNo    ;
//    LT.LotInfo.sJobFile   = Device   ;
//    LT.LotInfo.sOperator  = Operator ;

...
void __fastcall CArray::SetData(int _iData)
{
    m_iData = _iData ;
}

int __fastcall CArray::GetData(void)
{
    return m_iData ;
}
...
//    if (fp == NULL) return;
    ...
    if(IsLoad) {
        ...
        UserINI.Load(sPath, _iNo , "m_iData"   , m_iData   );
    }
    else {
        ...
        UserINI.Save(sPath, _iNo , "m_iData"   , m_iData   );
    }

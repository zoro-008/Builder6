...
void COptionMan::LoadCmnOptn()
{
    ...
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "bVsSndSkip          " , CmnOptn.bVsSndSkip          );
    ...
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "bEmptyNoTrm         " , CmnOptn.bEmptyNoTrm         );
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "iPSBSortMoveDelay   " , CmnOptn.iPSBSortMoveDelay   );
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "bUseTrimMachine     " , CmnOptn.bUseTrimMachine     );
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "iCheckFailCnt       " , CmnOptn.iCheckFailCnt       );
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "iLDRChangeCnt       " , CmnOptn.iLDRChangeCnt       );
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "bVisionAllSkip      " , CmnOptn.bVisionAllSkip      );
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "bUsePenMrk          " , CmnOptn.bUsePenMrk          );
//    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "bUsePenMrkMvDn      " , CmnOptn.bUsePenMrkMvDn      );
//    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "dPenMrkMoveDnLen    " , CmnOptn.dPenMrkMoveDnLen    );
...
//    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "dPenMrkMvY          " , CmnOptn.dPenMrkMvY          );
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "bEmptyOnlyTrm       " , CmnOptn.bEmptyOnlyTrm       );
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "b1stBMOnlyTrm       " , CmnOptn.b1stBMOnlyTrm       );
...
void COptionMan::SaveCmnOptn()
{
    ...
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "bVsSndSkip          " , CmnOptn.bVsSndSkip          );
    ...
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "bEmptyNoTrm         " , CmnOptn.bEmptyNoTrm         );
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "iPSBSortMoveDelay   " , CmnOptn.iPSBSortMoveDelay   );
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "bUseTrimMachine     " , CmnOptn.bUseTrimMachine     );
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "iCheckFailCnt       " , CmnOptn.iCheckFailCnt       );
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "iLDRChangeCnt       " , CmnOptn.iLDRChangeCnt       );
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "bVisionAllSkip      " , CmnOptn.bVisionAllSkip      );
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "bUsePenMrk          " , CmnOptn.bUsePenMrk          );
//    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "bUsePenMrkMvDn      " , CmnOptn.bUsePenMrkMvDn      );
//    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "dPenMrkMoveDnLen    " , CmnOptn.dPenMrkMoveDnLen    );
...
//    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "dPenMrkMvY          " , CmnOptn.dPenMrkMvY          );
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "bEmptyOnlyTrm       " , CmnOptn.bEmptyOnlyTrm       );
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "b1stBMOnlyTrm       " , CmnOptn.b1stBMOnlyTrm       );
...
void COptionMan::LoadMstOptn()
{
    ...
    UserINI.Load(sPath.c_str()  , "MstOptn"  , "bEmptyNoTrm   " , MstOptn.bEmptyNoTrm  );
...
void COptionMan::SaveMstOptn()
{
    ...
    UserINI.Save(sPath.c_str()  , "MstOptn"  , "bEmptyNoTrm   " , MstOptn.bEmptyNoTrm    );

...
//    else if(_iId == (int)aiPRB_Clamp    ) { }//bRet = PRB.CheckSafe((EN_ACTR_ID)_iId,_bFwd) ; } //모터 ㅜㅜ
//    else if(_iId == (int)aiPRB_CAlign   ) { bRet = PRB.CheckSafe((EN_ACTR_ID)_iId,_bFwd) ; }
...
//    else if(_iId == (int)aiWRE_CAlign   ) { bRet = RAE.CheckSafe((EN_ACTR_ID)_iId,_bFwd) ; }
//    else if(_iId == (int)aiWRD_Clamp    ) { }//bRet = RAD.CheckSafe((EN_ACTR_ID)_iId,_bFwd) ; }
//    else if(_iId == (int)aiWRD_CAlign   ) { bRet = RAD.CheckSafe((EN_ACTR_ID)_iId,_bFwd) ; }

...
__published:	// IDE-managed Components
    ...
    void __fastcall btSRT_AirClick(TObject *Sender);
    void __fastcall btIncMoveClick(TObject *Sender);
        void __fastcall btPinCntResetClick(TObject *Sender);
        void __fastcall btTSE_TestClick(TObject *Sender);
    void __fastcall btFeedClick(TObject *Sender);

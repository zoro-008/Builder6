...
void __fastcall TFrmMain::tmUpdateTimer(TObject *Sender)
{
    ...
    iLevel = FM_GetLevel();
    switch (iLevel) {
        case lvOperator : btUtilShow -> Enabled = false; break ;
        case lvEngineer : btUtilShow -> Enabled = true ; break ;
        case lvMaster   : btUtilShow -> Enabled = true ; break ;
        default         :                                break ;
    }

...
__fastcall CArray::CArray(void)
{
    ...
    if(bFirst) {
        //Default Set.
        clStat[csRslt0  ] = clPurple          ;//csInactiveCaption = 0  ,
        clStat[csRslt1  ] = clLime            ;//csMaroon          = 1  ,
        clStat[csRslt2  ] = clLime            ;//csPurple          = 2  ,
        clStat[csRslt3  ] = clRed             ;//csTeal            = 3  ,
        clStat[csRslt4  ] = clRed             ;//csOlive           = 4  ,
        clStat[csRslt5  ] = clRed             ;//csNavy            = 5  ,
        ...
        clStat[csUnkwn  ] = clGreen           ;//csAqua            = 20 ,//작업전 있는지 없는지 모르는 경우.

...
CIOs::CIOs()
{
    ...
    m_pIn  = new SBit[m_iMaxIn ] ; m_pInDelay  = new CDelayTimer[m_iMaxIn ];
    m_pOut = new SBit[m_iMaxOut] ; m_pOutDelay = new CDelayTimer[m_iMaxOut];
...
//            else             sAdd = "Y" + sAdd.sprintf ("%04d",m_pOut[i].iAdd) ;
            ...
            _sgTable -> Cells[6][i + 1] = m_pOut[i].iDelay ;
...
//            else             sAdd = "X" + sAdd.sprintf ("%04d",m_pIn[i].iAdd) ;
            ...
            _sgTable -> Cells[6][i + 1] = m_pIn[i].iDelay ;

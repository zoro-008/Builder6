...
void CErrMan::Save()
{
    ...
    for(int i = 0 ; i < m_iMaxErr ; i++) {
        ...
        UserINI.Save(sPath, "sName       ", sErrNo , Err[i].sName       );
        UserINI.Save(sPath, "sAction     ", sErrNo , Err[i].sAction     );
...
void CErrMan::Load()
{
    ...
    for(int i = 0 ; i < m_iMaxErr ; i++) {
        ...
        UserINI.Load(sPath, "sName       ", sErrNo , Err[i].sName       );
        UserINI.Load(sPath, "sAction     ", sErrNo , Err[i].sAction     );

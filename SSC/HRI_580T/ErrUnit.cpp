...
void __fastcall CErr::SaveOptionLog ( int iIndex , bool bInverse)
{
    ...
    if(bInverse) {
        switch(iIndex) {
            ...
            case 1 : if(OM.CmnOptn.bNoTrimFail    ) sData += "Saved NoTrimFail On"     ;
                     else                           sData += "Saved NoTrimFail Off"    ; break ;
            case 2 : if(OM.CmnOptn.bIgnrDoor      ) sData += "Saved IgnrDoor On"       ;
                     else                           sData += "Saved IgnrDoor Off"      ; break ;
            case 3 : if(OM.CmnOptn.bVisnSkip      ) sData += "Saved VisnSkip On"       ;
                     else                           sData += "Saved VisnSkip Off"      ; break ;
            case 4 : if(OM.CmnOptn.bAutoVsChange  ) sData += "Saved AutoVsChange On"   ;
                     else                           sData += "Saved AutoVsChange Off"  ; break ;
            case 5 : if(OM.CmnOptn.bAutoOperation ) sData += "Saved AutoOperation On"  ;
                     else                           sData += "Saved AutoOperation Off" ; break ;
            case 6 : if(OM.CmnOptn.bCheckSFailCnt ) sData += "Saved SameFailCnt On"    ;
                     else                           sData += "Saved SameFailCnt Off"   ; break ;
            case 7 : if(OM.CmnOptn.bCheckFailCnt  ) sData += "Saved FailCnt On"        ;
                     else                           sData += "Saved FailCnt Off"       ; break ;
            case 8 : if(OM.CmnOptn.bSortByItem    ) sData += "Saved SortByItem On"     ;
                     else                           sData += "Saved SortByItem Off"    ; break ;
        ...
        switch(iIndex) {
            ...
            case 1 : if(OM.CmnOptn.bNoTrimFail    ) sData += "Saved NoTrimFail Off"    ;
                     else                           sData += "Saved NoTrimFail On"     ; break ;
            case 2 : if(OM.CmnOptn.bIgnrDoor      ) sData += "Saved IgnrDoor Off"      ;
                     else                           sData += "Saved IgnrDoor On"       ; break ;
            case 3 : if(OM.CmnOptn.bVisnSkip      ) sData += "Saved VisnSkip Off"      ;
                     else                           sData += "Saved VisnSkip On"       ; break ;
            case 4 : if(OM.CmnOptn.bAutoVsChange  ) sData += "Saved AutoVsChange Off"  ;
                     else                           sData += "Saved AutoVsChange On"   ; break ;
            case 5 : if(OM.CmnOptn.bAutoOperation ) sData += "Saved AutoOperation Off" ;
                     else                           sData += "Saved AutoOperation On"  ; break ;
            case 6 : if(OM.CmnOptn.bCheckSFailCnt ) sData += "Saved SameFailCnt Off"   ;
                     else                           sData += "Saved SameFailCnt On"    ; break ;
            case 7 : if(OM.CmnOptn.bCheckFailCnt  ) sData += "Saved FailCnt Off"       ;
                     else                           sData += "Saved FailCnt On"        ; break ;
            case 8 : if(OM.CmnOptn.bSortByItem    ) sData += "Saved SortByItem Off"    ;
                     else                           sData += "Saved SortByItem On"     ; break ;
...
void __fastcall CErr::SaveOptionLog (AnsiString _sJobFile , AnsiString _sLotNo ,AnsiString _sSlotNo , AnsiString _sMsg)
{
    AnsiString sPath , sTemp , sData , sFPath;
    int hFile;
    int hwnd, flen;

...
struct CDevInfo {   //device에 대한 Dev_Info
    ...
    bool   bSSI        ; //Ver 1.0.2.3 특정 스트립만 검사 .
} ;
...
struct CDevOptn {   //Device에 따라 바뀌는 옵션.
    ...
    //2018 07 17 선계원..
    //서반에서 컨텍 안된다고 그래서 봐보니 8열컨텍보드가지고 4열만 꼽아서 쓴다.
    //그래서 컨텍은 4로 세팅 되고 억지로 프로브컨트롤러에NUM1032를 보내야 된다.
    bool   bUse8ColTo4ColProbe ; //8열 컨텍 보드를 4열 컨텍 보드로 사용.

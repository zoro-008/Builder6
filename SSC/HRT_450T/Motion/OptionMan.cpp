...
void COptionMan::LoadDevInfo(AnsiString _sDevName)
{
    ...
    UserINI.Load(sPath.c_str()  , "DevInfo"  , "bSSI        " , DevInfo.bSSI         );
...
void COptionMan::SaveDevInfo(AnsiString _sDevName)
{
    ...
    UserINI.Save(sPath.c_str()  , "DevInfo"  , "bSSI         " , DevInfo.bSSI         );
...
void COptionMan::LoadDevOptn(AnsiString _sDevName)
{
    ...
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "bIgnrVoidMotion    " , &DevOptn.bIgnrVoidMotion   );
    ...
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "bUse8ColTo4ColProbe" , &DevOptn.bUse8ColTo4ColProbe);
...
void COptionMan::SaveDevOptn(AnsiString _sDevName)
{
    ...
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "bIgnrVoidMotion    " , DevOptn.bIgnrVoidMotion   );    
    ...
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "bUse8ColTo4ColProbe" , DevOptn.bUse8ColTo4ColProbe);

...
/*  Blob    */
    SVL_API bool            __stdcall IBLB_Inspect   (IImage * _pImg , TRect _tRect , BLB_Para _tPara , BLB_Rslt * _pRslt);
...
/*  OCV     */
    SVL_API bool            __stdcall IOCV_Train     (IImage * _pImg , TRect _Rect , OCV_Para _tPara  ,  IArea * _pTrainArea , IImage * _pTrainImg) ;

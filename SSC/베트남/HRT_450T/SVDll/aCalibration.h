//---------------------------------------------------------------------------
#ifndef aCalibrationH
#define aCalibrationH
//---------------------------------------------------------------------------
#include "Image.h"
#include "aBlob.h"
...
class CCalibration
{
    ...
    public :
        ...
        bool       Inspect  (CImage *_pImg , TRect     _tRect , CAL_Para _tPara , CAL_Rslt *_pRslt                                  );
        void       PaintRslt(HDC     _hHdc , CAL_Rslt *_pRslt , CAL_Disp _tDisp , float    _fScaleX = 1.0 , float     _fScaleY = 1.0);

...
CPstnMan::CPstnMan()
{
    ...
    Value[miPR1_XCmp][pvPR1_XWait      ].sName = "Wait      " ;
    Value[miPR1_XCmp][pvPR1_XGrip      ].sName = "Grip      " ;
    Value[miPR1_XCmp][pvPR1_XPull      ].sName = "Pull      " ;
    Value[miPR1_XCmp][pvPR1_XBack      ].sName = "Back      " ;
    Value[miPR1_XCmp][pvPR1_XOut       ].sName = "Out       " ;

    Value[miPR2_XCmp][pvPR2_XWait      ].sName = "Wait      " ;
    Value[miPR2_XCmp][pvPR2_XGrip      ].sName = "Grip      " ;
    Value[miPR2_XCmp][pvPR2_XPull      ].sName = "Pull      " ;
    Value[miPR2_XCmp][pvPR2_XBack      ].sName = "Back      " ;
    Value[miPR2_XCmp][pvPR2_XIdCheck   ].sName = "IdCheck   " ;
    Value[miPR2_XCmp][pvPR2_XOut       ].sName = "Out       " ;

    Value[miWRK_XCmp][pvWRK_XWait      ].sName = "Wait      " ;
    Value[miWRK_XCmp][pvWRK_XGrip      ].sName = "Grip      " ;
    Value[miWRK_XCmp][pvWRK_XWorkStart ].sName = "WorkStart " ;
                                                               
    Value[miPSB_XCmp][pvPSB_XWait      ].sName = "Wait      " ;
    Value[miPSB_XCmp][pvPSB_XGrip      ].sName = "Grip      " ;
    Value[miPSB_XCmp][pvPSB_XPull      ].sName = "Pull      " ;
    Value[miPSB_XCmp][pvPSB_XBack      ].sName = "Back      " ;
    Value[miPSB_XCmp][pvPSB_XWorkStart ].sName = "WorkStart " ;
    Value[miPSB_XCmp][pvPSB_XOut       ].sName = "Out       " ;
    Value[miPSB_XCmp][pvPSB_XWRKGrip   ].sName = "WRKGrip   " ;

    Value[miWRK_ZTop][pvWRK_ZTWait     ].sName = "Wait      " ;
    Value[miWRK_ZTop][pvWRK_ZTWork     ].sName = "Work      " ;
    Value[miWRK_ZTop][pvWRK_ZTChange   ].sName = "Change    " ;

    Value[miWRK_ZBtm][pvWRK_ZBWait     ].sName = "Wait      " ;
    Value[miWRK_ZBtm][pvWRK_ZBWork     ].sName = "Work      " ;
    Value[miWRK_ZBtm][pvWRK_ZBChange   ].sName = "Change    " ;

    Value[miWRK_YBtm][pvWRK_YBWait     ].sName = "Wait      " ;
    Value[miWRK_YBtm][pvWRK_YBWork     ].sName = "Work      " ;
    Value[miWRK_YBtm][pvWRK_YBChange   ].sName = "Change    " ;
    
    Value[miWRK_XBtm][pvWRK_XBWait     ].sName = "Wait        " ;
    Value[miWRK_XBtm][pvWRK_XBWork     ].sName = "Work        " ;
    ...
    Value[miSTL_YTop][pvSTL_YTDevCheck ].sName = "DevCheck    " ;
    Value[miSTL_YTop][pvSTL_YTPlace    ].sName = "Place       " ;
//    Value[miSTL_YTop][pvSTL_YVoid      ].sName = "GripVoid    " ;

    Value[miREJ_XBtm][pvREJ_XBWait     ].sName = "Wait        " ;
    Value[miREJ_XBtm][pvREJ_XBWorkStart].sName = "WorkStart   " ;
    ...
    Value[miSTL_YBtm][pvSTL_YBWait     ].sName = "Wait        " ;
    Value[miSTL_YBtm][pvSTL_YBWorkStart].sName = "WorkStart   " ;
      ...
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
    ...
    if(2 == GridInfo.iCol ) {
         ...
         if(GridInfo.iGrid == miPR1_XCmp) PR1.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miPR2_XCmp) PR2.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);

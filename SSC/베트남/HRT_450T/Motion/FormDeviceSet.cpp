    ...
    : TForm(Owner)
{
    ...
    PM.SetWindow(pnSTL_YBtmPos , miSTL_YBtm);
//    PM.SetWindow(pnLd2Z,miLD2_Z);
  ...
  //  pcDeviceSet -> ActivePageIndex = 0 ;
    ...
    btSTL_Eje       -> Tag = OM.MstOptn.bUseSortBtmY ? (int)ySTL_PnchEjct : (int)ySTL_Ejecter   ;

    btPSB_Out2      -> Tag = (int)yPSB_FeedingAC ;
    btSTL_Eje2      -> Tag = OM.MstOptn.bUseSortBtmY ? (int)ySTL_PnchEjct : (int)ySTL_Ejecter   ;
    ...
    btSTL_Vac       -> Tag = (int)ySTL_PnchVacc;
    btSTL_Vac2      -> Tag = (int)ySTL_PnchVacc;
...
void __fastcall TFrmDeviceSet::FormShow(TObject *Sender)
{
    ...
    gbWRK_Hold  -> Visible = OM.MstOptn.bUsedXAxis ;
    gbWRK_Hold2 -> Visible = OM.MstOptn.bUsedXAxis ;
...
void __fastcall TFrmDeviceSet::pcDeviceSetChange(TObject *Sender)
{
    switch ( pcDeviceSet -> ActivePageIndex )
    {
        ...
        case 3 :
                 gbProbeBtmPstn -> Visible = OM.MstOptn.bUsedXAxis;
                 gbProbeBtmJog  -> Visible = OM.MstOptn.bUsedXAxis;
        ...
        case 4 :
                 gbSTL_YBtmPos -> Visible = OM.MstOptn.bUseSortBtmY ;
                 gbSTL_YBtm    -> Visible = OM.MstOptn.bUseSortBtmY ;

                 FraMotor[miSTL_YTop]->Parent = pnSTL_YTop ;
                 FraMotor[miREJ_XBtm]->Parent = pnRJT_XBtm ;
                 FraMotor[miSTL_YBtm]->Parent = pnSTL_YBtm ;
                 ...
                 PM.SetParent(pnSTL_YBtmPos , miSTL_YBtm);
                 break;

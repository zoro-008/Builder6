...
//    UserINI.Load(sPath.c_str()  , "MstOptn"  , "sPstEquipIp        " , &MstOptn.sPstEquipIp       );
    ...
    UserINI.Load(sPath.c_str()  , "MstOptn"  , "bUseSortBtmY       " , &MstOptn.bUseSortBtmY      );

    UserINI.Load(sPath.c_str()  , "MstOptn"  , "bIgnrVoidMotion    " , &MstOptn.bIgnrVoidMotion   );
...
//    UserINI.Save(sPath.c_str()  , "MstOptn"  , "sPstEquipIp        " ,  MstOptn.sPstEquipIp       );
    ...
    UserINI.Save(sPath.c_str()  , "MstOptn"  , "bUseSortBtmY       " ,  MstOptn.bUseSortBtmY      );

    UserINI.Save(sPath.c_str()  , "MstOptn"  , "bIgnrVoidMotion    " ,  MstOptn.bIgnrVoidMotion   );
}

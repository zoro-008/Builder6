...
//        edPostEquipIp      -> Text    = OM.MstOptn.sPstEquipIp       ;
        ...
        cbUseSortBtmY       -> Checked = OM.MstOptn.bUseSortBtmY      ;

        cbIgnrVoidMotion    -> Checked = OM.MstOptn.bIgnrVoidMotion    ;
    }
    else{
...
//        OM.MstOptn.sPstEquipIp        = edPostEquipIp      -> Text    ;
        ...
        OM.MstOptn.bUseSortBtmY       = cbUseSortBtmY      -> Checked ;
        ...
        OM.MstOptn.bIgnrVoidMotion    = cbIgnrVoidMotion    -> Checked ;

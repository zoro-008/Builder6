...
void __fastcall TFrmLotOpen::btLotOpenClick(TObject *Sender)
{
    ...
    bool bStart = DM.ARAY[riLD1].GetCntStat(csNone) &&
                  ...
                  DM.ARAY[riPS1].GetCntStat(csNone) &&
                  DM.ARAY[riPS2].GetCntStat(csNone) && LT.m_bLotOpen;
    ...
    if(bStart)LD1.SetMgzCnt (OM.DevOptn.iLotEndMgzCnt);

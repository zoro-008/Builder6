...
void COptionMan::LoadDevOptn(AnsiString _sDevName)
{
    ...
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "iPinCtCnt        " , &DevOptn.iPinCtCnt       );
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "iLimPinCtCnt     " , &DevOptn.iLimPinCtCnt    );
...
void COptionMan::SaveDevOptn(AnsiString _sDevName)
{
    ...
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "iPinCtCnt        " , DevOptn.iPinCtCnt       );
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "iLimPinCtCnt     " , DevOptn.iLimPinCtCnt    );
...
//    UserINI.Load(sPath.c_str()  , "MstOptn"  , "bUseHangul         " , &MstOptn.bUseHangul        );
    ...
    UserINI.Load(sPath.c_str()  , "MstOptn"  , "iGlProbeVer        " , &MstOptn.iGlProbeVer       );
...
//    UserINI.Save(sPath.c_str()  , "MstOptn"  , "bUseHangul         " ,  MstOptn.bUseHangul        );
    ...
    UserINI.Save(sPath.c_str()  , "MstOptn"  , "iGlProbeVer        " ,  MstOptn.iGlProbeVer       );
...
void COptionMan::LoadLastInfo()
{
    ...
    UserINI.Load(sPath, "LAST LANG INFO" , "iLangSel "  , m_iLangSel );
...
void COptionMan::SaveLastInfo()
{
    ...
    UserINI.Save(sPath, "LAST LANG INFO" , "iLangSel "  , m_iLangSel );
}

...
extern EN_PROB_RSLT iCChipRsltCrnt[MAX_ARRAY_ROW][MAX_CONTACT_COL] ;
extern double       dCChipVfCrnt  [MAX_ARRAY_ROW][MAX_CONTACT_COL] ;
extern double       dCChipVrCrnt  [MAX_ARRAY_ROW][MAX_CONTACT_COL] ;

//현재 작업 중인 스트립의 데이터
extern EN_PROB_RSLT iCChipRslt[MAX_ARRAY_ROW][MAX_ARRAY_COL];
extern double       dCChipVf  [MAX_ARRAY_ROW][MAX_ARRAY_COL];
extern double       dCChipVr  [MAX_ARRAY_ROW][MAX_ARRAY_COL];

//전에 작업 했던 스트립의 데이터.
extern EN_PROB_RSLT iPChipRslt[MAX_ARRAY_ROW][MAX_ARRAY_COL];

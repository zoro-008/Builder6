...
//    double dTemp2 = GetTickTime();
//    double dTemp3 = dTemp2 - dTemp1 ;
//    Label1->Caption = dTemp3 ;
...
//    else                               PCM.Set1();
    ...
    if(bSuccess) tmMainSet->Enabled = true ;
//    else                               PCM.Set2();
...
//    Sleep(1);
    ...
    static AnsiString sRcvTestMsg2 = "" ;
...
//    if(sRcvMsg.Pos("OK\rPUT")) {
//        sRcvMsg.Delete(1,sRcvMsg.Pos("OK\r")+2);
//    }
    if(sRcvMsg.Pos("\rPUT")) {
        sRcvMsg.Delete(sRcvMsg.Pos("\rPUT"),5);
    }

    if(sRcvTestMsg.Pos("T") && !sRcvTestMsg.Pos("PUT") ) {
        sRcvTestMsg2 = sRcvTestMsg.SubString(sRcvTestMsg.Pos("T")+1,4);
        sRcvTestMsg2 = 0.0012 * sRcvTestMsg2.ToIntDef(-1) * 3  ;

        FrmDeviceSet->mmProbeTest->Lines->Add(sRcvTestMsg2) ;
        FrmDeviceSet->bComTest = true ;
//        sRcvMsg = "" ;
    }
...
//                  return ;
        ...
        case  15: if(!g_bPb1Rslt) return ;
                  g_bPb1Rslt = false ;
                       ...
                       if(OM.MstOptn.iGlProbeVer == 0 ) sMsg = sTemp.sprintf("%04d" ,OM.DevOptn.i1ChLedTime   ) ;
                  else if(OM.MstOptn.iGlProbeVer == 1 ) sMsg = sTemp.sprintf("%04d" ,OM.DevOptn.i1ChLedTime   ) ;
                  else if(OM.MstOptn.iGlProbeVer == 2 ) sMsg = sTemp.sprintf("%05d" ,OM.DevOptn.i1ChLedTime/2 ) ;
                  sMsg = "SET,LIT"+ sMsg + "#";
                  RS232C_Pb1ch->WriteData(sMsg.Length(),sMsg.c_str());
                  /*
        ...
        case  16: if(!g_bPb1Rslt) return ;
                  g_bPb1Rslt = false ;
                       ...
                       if(OM.MstOptn.iGlProbeVer == 0 ) sMsg = sTemp.sprintf("%04d" ,OM.DevOptn.i1ChZenTime   ) ;
                  else if(OM.MstOptn.iGlProbeVer == 1 ) sMsg = sTemp.sprintf("%04d" ,OM.DevOptn.i1ChZenTime   ) ;
                  else if(OM.MstOptn.iGlProbeVer == 2 ) sMsg = sTemp.sprintf("%05d" ,OM.DevOptn.i1ChZenTime/2 ) ;
                  sMsg = "SET,ZIT"+ sMsg + "#";
                  RS232C_Pb1ch->WriteData(sMsg.Length(),sMsg.c_str());
                  /*
        ...
        case  17: if(!g_bPb1Rslt) return ;
                  ...
                  sMsg = "SET,LN"+ sMsg + "#";
                  RS232C_Pb1ch->WriteData(sMsg.Length(),sMsg.c_str());
                  if(OM.MstOptn.iGlProbeVer == 0) { iStep = 19; return ; }
                  iStep++;
                  return ;
...
//                  return ;
        ...
        case  24: //if(!g_bPb2Rslt) return ;
                  ...
                  sMsg = sTemp.sprintf("%04d" ,OM.DevOptn.i2ChDelay ) ;
...
//                  sMsg = "SET,DLY1000#";
        ...
        case  25: if(!g_bPb2Rslt) return ;
                  g_bPb2Rslt = false ;
                       if(OM.MstOptn.iGlProbeVer == 0 ) sMsg = sTemp.sprintf("%04d" ,OM.DevOptn.i2ChLedTime   ) ;
                  else if(OM.MstOptn.iGlProbeVer == 1 ) sMsg = sTemp.sprintf("%04d" ,OM.DevOptn.i2ChLedTime   ) ;
                  else if(OM.MstOptn.iGlProbeVer == 2 ) sMsg = sTemp.sprintf("%05d" ,OM.DevOptn.i2ChLedTime/2 ) ;
        ...
        case  26: if(!g_bPb2Rslt) return ;
                  g_bPb2Rslt = false ;
                       if(OM.MstOptn.iGlProbeVer == 0 ) sMsg = sTemp.sprintf("%04d" ,OM.DevOptn.i2ChZenTime   ) ;
                  else if(OM.MstOptn.iGlProbeVer == 1 ) sMsg = sTemp.sprintf("%04d" ,OM.DevOptn.i2ChZenTime   ) ;
                  else if(OM.MstOptn.iGlProbeVer == 2 ) sMsg = sTemp.sprintf("%05d" ,OM.DevOptn.i2ChZenTime/2 ) ;
        ...
        case  28: if(!g_bPb2Rslt) return ;
                  ...
                  if(OM.MstOptn.iGlProbeVer == 0) { iStep = 30; return ; }
                  iStep++;
                  return ;

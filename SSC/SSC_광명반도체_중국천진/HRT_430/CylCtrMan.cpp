...
//    if(MAX_MOTR != MT_GetMotorCnt()) {ShowMessageT("Motor Count is wrong");}
    ...
    ValACT[tmACT1].sName = "AC MOTOR\rIN BELT"      ;
    ValACT[tmACT2].sName = "AC MOTOR\rOUT BELT"     ;

    ValACT[tmACT3].sName = "Pre Buffer\rBELT" ;
    ValACT[tmACT4].sName = "Pre Buffer\r1st CLAMP" ;
    ValACT[tmACT5].sName = "Pre Buffer\rID_CHECK"  ;
    ValACT[tmACT6].sName = "Work Zone\r2st CLAMP" ;
    ValACT[tmACT7].sName = "Post Buffer\r3st CLAMP" ;

    //ACTuator Index                               //ACTuator Row,Col
    ValACT[tmACT0].iACTId = (int)aiLD1_Cmp       ; ValACT[tmACT0].iRow = 0 ; ValACT[tmACT0].iCol = 0 ;
    ValACT[tmACT1].iACTId = (int)yLD1_MgzInAC    ; ValACT[tmACT1].iRow = 0 ; ValACT[tmACT1].iCol = 1 ;
    ValACT[tmACT2].iACTId = (int)yLD1_MgzOutAC   ; ValACT[tmACT2].iRow = 0 ; ValACT[tmACT2].iCol = 2 ;

    ValACT[tmACT3].iACTId = (int)yPRB_FeedingAC  ; ValACT[tmACT3].iRow = 0 ; ValACT[tmACT3].iCol = 0 ;
    ValACT[tmACT4].iACTId = (int)aiPRB_Cmp       ; ValACT[tmACT4].iRow = 0 ; ValACT[tmACT4].iCol = 1 ;
    ValACT[tmACT5].iACTId = (int)aiPRB_IdChk     ; ValACT[tmACT5].iRow = 0 ; ValACT[tmACT5].iCol = 2 ;
    ValACT[tmACT6].iACTId = (int)aiWRK_Cmp       ; ValACT[tmACT6].iRow = 0 ; ValACT[tmACT6].iCol = 3 ;
    ValACT[tmACT7].iACTId = (int)aiPSB_Cmp       ; ValACT[tmACT7].iRow = 0 ; ValACT[tmACT7].iCol = 4 ;

    //ACTinder Jog Disp Type
    ValACT[tmACT0].iType = cdtUpDown ;
    ValACT[tmACT1].iType = cdtOnOff  ;
    ValACT[tmACT2].iType = cdtOnOff  ;

    ValACT[tmACT3].iType = cdtOnOff  ;
    ValACT[tmACT4].iType = cdtUpDown ;
    ValACT[tmACT5].iType = cdtUpDown ;
    ValACT[tmACT6].iType = cdtUpDown ;
    ValACT[tmACT7].iType = cdtUpDown ;

    ValTab[ctiLDR  ].iACTCnt = 3 ;
    ValTab[ctiRAIL ].iACTCnt = 5 ;

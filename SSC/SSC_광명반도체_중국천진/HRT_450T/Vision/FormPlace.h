...
__published:	// IDE-managed Components
        ...
        void __fastcall sbPlcPxMinPerChange(TObject *Sender);
private:	// User declarations
        EN_VISN_ID m_iVisnId ;
public:		// User declarations
        __fastcall TFrmPlace(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFrmPlace *FrmPlace;
//---------------------------------------------------------------------------
#endif

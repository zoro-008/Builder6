    ...
    : TForm(Owner)
{
    ...
    sgLotInfo   ->Cells[19][0] = "Chip"     ;
    sgLotInfo   ->Cells[20][0] = "Dust"     ;
    sgLotInfo   ->Cells[21][0] = "L_Flow"   ;
    sgLotInfo   ->Cells[22][0] = "Broken"   ;
    sgLotInfo   ->Cells[23][0] = "Crack"    ;
    sgLotInfo   ->Cells[24][0] = "Burr"     ;
    sgLotInfo   ->Cells[25][0] = "Zener"    ;
    sgLotInfo   ->Cells[26][0] = "Wire"     ;
    sgLotInfo   ->Cells[27][0] = "Orient"   ;
    sgLotInfo   ->Cells[28][0] = "PMeasure" ;
    sgLotInfo   ->Cells[29][0] = "PDist"    ;
    sgLotInfo   ->Cells[30][0] = "Matching" ;
    sgLotInfo   ->Cells[31][0] = "Flow"     ;

...
private:	// User declarations
    ...
    void __fastcall RcvTempCon  (TMessage &Message);
    ...
    BEGIN_MESSAGE_MAP
        ...
        MESSAGE_HANDLER(UM_EVN_RXCHAR_TEMP , TMessage, RcvTempCon   )
...
extern AnsiString g_sPb1Bin[2] ;  //
extern AnsiString g_sPb2Bin[2] ;  //
extern AnsiString g_sPb1Vf[2]  ;
extern AnsiString g_sPb2Vf[2]  ;

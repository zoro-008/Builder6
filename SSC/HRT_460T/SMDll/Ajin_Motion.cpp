...
void MakeAjinUI()
{
    ...
    AjinParaUi.cbEncReverse   = new TCheckBox(AjinParaUi.pnBase); AjinParaUi.cbEncReverse   -> Parent = AjinParaUi.pnBase ; AjinParaUi.cbEncReverse   -> Caption = "Enc Reverse        " ; SetAjinArrange(AjinParaUi.cbEncReverse   , 0 , 2 );
    AjinParaUi.cbUse360Count  = new TCheckBox(AjinParaUi.pnBase); AjinParaUi.cbUse360Count  -> Parent = AjinParaUi.pnBase ; AjinParaUi.cbUse360Count  -> Caption = "Enc 360 Reset      " ; SetAjinArrange(AjinParaUi.cbUse360Count  , 0 , 2 );



    AjinParaUi.cbEncInput     = new TComboBox(AjinParaUi.pnBase); AjinParaUi.cbEncInput     -> Parent = AjinParaUi.pnBase ;                                                               SetAjinArrange(AjinParaUi.cbEncInput     , 1 , 3 );
    AjinParaUi.lbEncInput     = new TLabel(AjinParaUi.pnBase);    AjinParaUi.lbEncInput     -> Parent = AjinParaUi.pnBase ; AjinParaUi.lbEncInput     -> Caption = "Enc Input          " ; SetAjinArrange(AjinParaUi.lbEncInput     , 0 , 3 );

    AjinParaUi.cbPulseOutput  = new TComboBox(AjinParaUi.pnBase); AjinParaUi.cbPulseOutput  -> Parent = AjinParaUi.pnBase ;                                                               SetAjinArrange(AjinParaUi.cbPulseOutput  , 1 , 4 );
    AjinParaUi.lbPulseOutput  = new TLabel(AjinParaUi.pnBase);    AjinParaUi.lbPulseOutput  -> Parent = AjinParaUi.pnBase ; AjinParaUi.lbPulseOutput  -> Caption = "Pulse Output Method" ; SetAjinArrange(AjinParaUi.lbPulseOutput  , 0 , 4 );

    AjinParaUi.edSCurveAcPer  = new TEdit    (AjinParaUi.pnBase); AjinParaUi.edSCurveAcPer  -> Parent = AjinParaUi.pnBase ;                                                               SetAjinArrange(AjinParaUi.edSCurveAcPer  , 1 , 5 );
    AjinParaUi.lbSCurveAcPer  = new TLabel(AjinParaUi.pnBase);    AjinParaUi.lbSCurveAcPer  -> Parent = AjinParaUi.pnBase ; AjinParaUi.lbSCurveAcPer  -> Caption = "S Curve Acc %      " ; SetAjinArrange(AjinParaUi.lbSCurveAcPer  , 0 , 5 );

    AjinParaUi.edSCurveDcPer  = new TEdit    (AjinParaUi.pnBase); AjinParaUi.edSCurveDcPer  -> Parent = AjinParaUi.pnBase ;                                                               SetAjinArrange(AjinParaUi.edSCurveDcPer  , 1 , 6 );
    AjinParaUi.lbSCurveDcPer  = new TLabel   (AjinParaUi.pnBase); AjinParaUi.lbSCurveDcPer  -> Parent = AjinParaUi.pnBase ; AjinParaUi.lbSCurveDcPer  -> Caption = "S Curve Dcc %      " ; SetAjinArrange(AjinParaUi.lbSCurveDcPer  , 0 , 6 );

    AjinParaUi.cbHomeActLevel = new TCheckBox(AjinParaUi.pnBase); AjinParaUi.cbHomeActLevel -> Parent = AjinParaUi.pnBase ; AjinParaUi.cbHomeActLevel -> Caption = "Home Active High   " ; SetAjinArrange(AjinParaUi.cbHomeActLevel , 0 , 7 );

    AjinParaUi.cbPLimActLevel = new TCheckBox(AjinParaUi.pnBase); AjinParaUi.cbPLimActLevel -> Parent = AjinParaUi.pnBase ; AjinParaUi.cbPLimActLevel -> Caption = "+ Limit Active High" ; SetAjinArrange(AjinParaUi.cbPLimActLevel , 0 , 8 );

    AjinParaUi.cbNLimActLevel = new TCheckBox(AjinParaUi.pnBase); AjinParaUi.cbNLimActLevel -> Parent = AjinParaUi.pnBase ; AjinParaUi.cbNLimActLevel -> Caption = "- Limit Active High" ; SetAjinArrange(AjinParaUi.cbNLimActLevel , 0 , 9 );

    AjinParaUi.cbAlarmActLevel= new TCheckBox(AjinParaUi.pnBase); AjinParaUi.cbAlarmActLevel-> Parent = AjinParaUi.pnBase ; AjinParaUi.cbAlarmActLevel-> Caption = "Alarm Active High  " ; SetAjinArrange(AjinParaUi.cbAlarmActLevel, 0 , 10);

    AjinParaUi.cbInposActLevel= new TCheckBox(AjinParaUi.pnBase); AjinParaUi.cbInposActLevel-> Parent = AjinParaUi.pnBase ; AjinParaUi.cbInposActLevel-> Caption = "Inpos Active High  " ; SetAjinArrange(AjinParaUi.cbInposActLevel, 0 , 11);

    AjinParaUi.cbZphaActLevel = new TCheckBox(AjinParaUi.pnBase); AjinParaUi.cbZphaActLevel -> Parent = AjinParaUi.pnBase ; AjinParaUi.cbZphaActLevel -> Caption = "Z Active High  "     ; SetAjinArrange(AjinParaUi.cbZphaActLevel , 0 , 12);
}
...
bool CAjinMotion::GetServo()
{
    ...
    AxmSignalReadOutputBit(AjinPara.iPhysicalNo,iServoOnBit,&dwpServoOnLevel);
...
void CAjinMotion::SetGantryEnable(int _iMasterAxis , int _iSlaveAxis , int _iHomeUse , double _dSlaveOffset , double _dSlOffsetRange)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
    AxmGantrySetEnable(_iMasterAxis , _iSlaveAxis , _iHomeUse , _dSlaveOffset , _dSlOffsetRange);
#endif //AJIN_AXL
}

void CAjinMotion::SetGantryDisable(int _iMasterAxis , int _iSlaveAxis)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
    AxmGantrySetDisable(_iMasterAxis , _iSlaveAxis);
#endif //AJIN_AXL
}

void CAjinMotion::SetHomeMethod(int _iAxis , int _iHomeDir , DWORD _dwHomeSignal , DWORD _dwUseZ , double _dHomeClrTime , double _dHomeOffset)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
    AxmHomeSetMethod(_iAxis , _iHomeDir , _dwHomeSignal , _dwUseZ , _dHomeClrTime , _dHomeOffset);
#endif //AJIN_AXL
}

void CAjinMotion::SetHomeVel(int _iAxis , double _dVel1 , double _dVel2 , double _dVel3 , double _dLast ,double _dAcc1 , double _dAcc2)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
    AxmHomeSetVel(_iAxis , _dVel1 , _dVel2 , _dVel3 , _dLast , _dAcc1 ,  _dAcc2);
#endif //AJIN_AXL
}

void CAjinMotion::SetHomeStart(int _iAxis)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
    AxmHomeSetStart(_iAxis );
#endif //AJIN_AXL
}

void CAjinMotion::GetHomeResult(int _iAxis , DWORD *_dwResult)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
    AxmHomeGetResult(_iAxis , _dwResult);
#endif //AJIN_AXL

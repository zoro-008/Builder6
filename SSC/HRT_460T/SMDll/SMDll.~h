...
extern "C" {
    ...
    SML_API void __stdcall SetOverrideMaxSpeed(int _iAxisNo , double _dOverSped);
    SML_API void __stdcall SetOverrideVel     (int _iAxisNo , double _dOverSped);
    SML_API void __stdcall SetOverrideVelAtPos(int _iAxisNo , double _dPos, double _dVel, double _dOverPos, double _dOverSped, bool _bCmd);

    // 보간 운동 추가
    SML_API void __stdcall MT_ContiWriteClear   (int _iCoord                                  );
    SML_API void __stdcall MT_ContiSetAxisMap   (int _iCoord, int _iAxisCnt, int * _ipAxisNo  );
    SML_API void __stdcall MT_ContiSetAbsRelMode(int _iCoord, DWORD _dwAbsRelMode             );
    SML_API void __stdcall MT_ContiBeginNode    (int _iCoord                                  );
    SML_API void __stdcall MT_ContiEndNode      (int _iCoord                                  );
    SML_API void __stdcall MT_ContiStart        (int _iCoord, DWORD _dwProfileset, int _iAngle);
    SML_API int  __stdcall MT_GetContCrntIdx    (int _iCoord);
    SML_API void __stdcall MT_LineMove          (int _iCoord, int *_ipAxisNo, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, int _iAxisCnt);
    SML_API void __stdcall MT_CircleCenterMove  (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpCenterPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir);
    SML_API void __stdcall MT_CirclePointMove   (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpMidPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, int _iArcCircle);
    SML_API void __stdcall MT_CircleRadiuMove   (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double _dRadius, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir, DWORD _dwShortDistance);
    SML_API void __stdcall MT_CircleAngleMove   (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dCenterPos, double _dAngle, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir);
    ...
    SML_API void __stdcall MT_SetGantryEnable   (int _iMasterAxis , int _iSlaveAxis , int _iHomeUse , double _dSlaveOffset , double _dSlOffsetRange);
    SML_API void __stdcall MT_SetGantryDisable  (int _iMasterAxis , int _iSlaveAxis);
    SML_API void __stdcall MT_SetHomeStart      (int _iAxis);
    SML_API bool __stdcall MT_GetHomeResult     (int _iAxis);
...
//    SML_API void       __stdcall AT_DelCntrlPn  (int _iActrNo                                                );
    ...
    SML_API void       __stdcall EM_SetErrMsg     (int  _iNo , char * _sErrMsg);
    SML_API char *     __stdcall EM_GetErrMsg     (int  _iNo); //EM_SetErrMsg로 세팅된 서브 메세지 받아온다.
    ...
    //TowerLamp Class.//
    ////////////////////
    SML_API void       __stdcall TL_MuteSnd       (bool _bOn); //타워램프 소리 끄기.

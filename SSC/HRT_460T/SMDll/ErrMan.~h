...
class CErrMan
{
    ...
    protected:
        ...
        bool   m_bUsedErrPictr ; //true 일때만 사진 띄어준다.
        void  LoadDnmVar();
        void  SaveDnmVar();
    ...
    public:
        ...
        void       SetErrMsg (int  _iNo , AnsiString _sErrMsg);
        AnsiString GetErrMsg (int _iNo );
        ...
        int   GetErrCnt (    ); //총 에러 발생 갯수.
        int   GetMaxErr (    ); //할당 되어 있는 총 에러갯수 리턴.
        bool  GetErr    (int _iNo); //해당번호의 에러가 떠있는지.

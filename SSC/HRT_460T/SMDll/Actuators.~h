...
class CActuator {
    public :
        ...
        struct SPara {
            ...
            AnsiString sName       ;
            AnsiString sComment    ;
            int        iFwdXAdd[MAX_X_CNT]    ;
            int        iBwdXAdd[MAX_X_CNT]    ;
            int        iFwdYAdd    ;
            int        iBwdYAdd    ;
            int        iFwdOnDelay ;
            int        iBwdOnDelay ;
            int        iFwdTimeOut ;
            int        iBwdTimeOut ;
            int        iDirType    ; //EN_ACTR_DIRECTION
        };
    ...
    public :
        ...
        bool       GetFwdX  (bool _bDirct=false);
        bool       GetBwdX  (bool _bDirct=false);
...
//       CActuator * Actuators ;
        ...
        EN_ACTR_DIRECTION GetDirType(int _iActrNo);
    ...
    public :
        ...
        void DisplayProperty(bool  _bToTble        , TEdit       * _edEnum    ,

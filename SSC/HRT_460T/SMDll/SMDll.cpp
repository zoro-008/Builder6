...
extern "C" SML_API
void __stdcall MT_SetOverrideMaxSpeed(int _iAxisNo , double _dOverSped)
{
    MT.SetOverrideMaxSpeed(_iAxisNo ,_dOverSped ) ;
}
extern "C" SML_API
void __stdcall MT_SetOverrideVel     (int _iAxisNo , double _dOverSped)
{
    MT.SetOverrideVel(_iAxisNo , _dOverSped);
}
extern "C" SML_API
void __stdcall MT_SetOverrideVelAtPos(int _iAxisNo , double _dPos, double _dVel, double _dOverPos, double _dOverSped, bool _bCmd)
{
    MT.SetOverrideVelAtPos(_iAxisNo , _dPos, _dVel, _dOverPos, _dOverSped, _bCmd);
}
// 보간 구동 추가
extern "C" SML_API
void __stdcall MT_ContiSetAxisMap(int _iCoord, int _iAxisCnt, int *_ipAxisNo)
{
    MT.ContiSetAxisMap(_iCoord, _iAxisCnt, _ipAxisNo) ;
}

extern "C" SML_API
void __stdcall MT_ContiSetAbsRelMode(int _iCoord, DWORD _dwAbsRelMode)
{
    MT.ContiSetAbsRelMode(_iCoord, _dwAbsRelMode) ;
}

extern "C" SML_API
void __stdcall MT_ContiBeginNode(int _iCoord)
{
    MT.ContiBeginNode(_iCoord) ;
}

extern "C" SML_API
void __stdcall MT_ContiEndNode(int _iCoord)
{
    MT.ContiEndNode(_iCoord) ;
}

extern "C" SML_API
void __stdcall MT_ContiStart(int _iCoord, DWORD _dwProfileset, int _iAngle)
{
    MT.ContiStart(_iCoord, _dwProfileset, _iAngle) ;
}

extern "C" SML_API
int __stdcall MT_GetContCrntIdx(int _iCoord)
{
    return MT.GetContCrntIdx(_iCoord) ;
}

extern "C" SML_API
void __stdcall MT_LineMove(int _iCoord, int *_ipAxisNo, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, int _iAxisCnt)
{
    MT.LineMove(_iCoord, _ipAxisNo, _dpEndPos, _dVel, _dAcc, _dDec, _iAxisCnt);
}

extern "C" SML_API
void __stdcall MT_CircleCenterMove(int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpCenterPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir)
{
    MT.CircleCenterMove(_iCoord, _ipAxisNo, _iAxisCnt, _dpCenterPos, _dpEndPos, _dVel, _dAcc, _dDec, _dwCWDir);
}

extern "C" SML_API
void __stdcall MT_CirclePointMove(int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpMidPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDe, int _iArcCircle)
{
    MT.CirclePointMove(_iCoord, _ipAxisNo, _iAxisCnt, _dpMidPos, _dpEndPos, _dVel, _dAcc, _dDe, _iArcCircle);
}

extern "C" SML_API
void __stdcall MT_CircleRadiusMove(int _iCoord, int *_ipAxisNo, int _iAxisCnt, double _dRadius, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir, DWORD _dwShortDistance)
{
    MT.CircleRadiusMove(_iCoord, _ipAxisNo, _iAxisCnt, _dRadius, _dpEndPos,_dVel, _dAcc, _dDec, _dwCWDir, _dwShortDistance);
}

extern "C" SML_API
void __stdcall MT_CircleAngleMove(int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dCenterPos, double _dAngle, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir)
{
    MT.CircleAngleMove(_iCoord, _ipAxisNo, _iAxisCnt, _dCenterPos, _dAngle, _dVel, _dAcc, _dDec, _dwCWDir);
}

void __stdcall MT_SetGantryEnable(int _iMasterAxis , int _iSlaveAxis , int _iHomeUse , double _dSlaveOffset , double _dSlOffsetRange)
{
    MT.SetGantryEnable(_iMasterAxis , _iSlaveAxis , _iHomeUse , _dSlaveOffset , _dSlOffsetRange);
}
void __stdcall MT_SetGantryDisable(int _iMasterAxis , int _iSlaveAxis)
{
    MT.SetGantryDisable(_iMasterAxis , _iSlaveAxis);
}

//겐트리용 홈함수.
void __stdcall MT_SetHomeStart(int _iAxis)
{
    MT.SetHomeStart(_iAxis);
}

bool __stdcall MT_GetHomeResult(int _iAxis)
{
    return MT.GetHomeResult(_iAxis);
}

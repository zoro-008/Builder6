...
void COptionMan::LoadDevOptn(AnsiString _sDevName)
{
    ...
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "dWorkXWaitOfs      " , &DevOptn.dWorkXWaitOfs     );
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "dWRKZTopSpeed      " , &DevOptn.dWRKZTopSpeed     );
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "bWRKZTopRepeat     " , &DevOptn.bWRKZTopRepeat    );
    ...
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "iPRBRlrDelay       " , &DevOptn.iPRBRlrDelay      );
    UserINI.Load(sPath.c_str()  , "DevOptn"  , "iPRBRlrOffDelay    " , &DevOptn.iPRBRlrOffDelay   );
...
void COptionMan::SaveDevOptn(AnsiString _sDevName)
{
    ...
    //Save Device.
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "dWorkXWaitOfs      " , DevOptn.dWorkXWaitOfs     );
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "dWRKZTopSpeed      " , DevOptn.dWRKZTopSpeed     );
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "bWRKZTopRepeat     " , DevOptn.bWRKZTopRepeat    );
    ...
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "iPRBRlrDelay       " , DevOptn.iPRBRlrDelay      );
    UserINI.Save(sPath.c_str()  , "DevOptn"  , "iPRBRlrOffDelay    " , DevOptn.iPRBRlrOffDelay   );
...
void COptionMan::LoadCmnOptn()
{
    ...
    UserINI.Load(sPath.c_str()  , "CmnOptn"  , "bIgnrVisn       " , &CmnOptn.bIgnrVisn       );
...
void COptionMan::SaveCmnOptn()
{
    ...
    UserINI.Save(sPath.c_str()  , "CmnOptn"  , "bIgnrVisn       " , CmnOptn.bIgnrVisn       );
...
//    UserINI.Load(sPath.c_str()  , "MstOptn"  , "sPstEquipIp        " , &MstOptn.sPstEquipIp       );
    ...
    UserINI.Load(sPath.c_str()  , "MstOptn"  , "bUsed4RowCntct     " , &MstOptn.bUsed4RowCntct    );
...
//    UserINI.Save(sPath.c_str()  , "MstOptn"  , "sPstEquipIp        " ,  MstOptn.sPstEquipIp       );
    ...
    UserINI.Save(sPath.c_str()  , "MstOptn"  , "bUsed4RowCntct     " ,  MstOptn.bUsed4RowCntct    );
...
void COptionMan::LoadEqpOptn()
{
    ...
    TUserINI   UserINI;
    AnsiString sPath  ;
    AnsiString sModelName = "HRT-460S";

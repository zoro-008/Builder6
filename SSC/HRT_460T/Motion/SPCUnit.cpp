...
void __fastcall CSPC::SaveOptionLog ( int iIndex , bool bInverse)
{
    ...
    if(bInverse) {
        switch(iIndex) {
            ...
            case 2 : if(OM.CmnOptn.bIgnrVisn      ) sData += "Saved IgnrVision On"       ;
                     else                           sData += "Saved IgnrVision Off"      ;break ;
            ...
            case 5 : if(OM.CmnOptn.bLoadingStop   ) sData += "Saved LoadingStop On"      ;
                     else                           sData += "Saved LoadingStop Off"     ; break ;
            case 6 : if(OM.CmnOptn.bCheckFailCnt  ) sData += "Saved CheckFailCnt On"     ;
                     else                           sData += "Saved CheckFailCnt Off"    ; break ;
            //case 7 : if(OM.CmnOptn.bAutoConvesion ) sData += "Saved AutoConvesion On"    ;
            //         else                           sData += "Saved AutoConvesion Off"   ; break ;
            //case 8 : if(OM.CmnOptn.bAutoOperation ) sData += "Saved AutoOperation On"    ;
            //         else                           sData += "Saved AutoOperation Off"   ; break ;
            case 9 : if(OM.CmnOptn.bIgnrTrim      ) sData += "Saved IgnrTrim On"         ;
                     else                           sData += "Saved IgnrTrim Off"        ; break ;
            case 10: if(OM.CmnOptn.bIgnrDrop      ) sData += "Saved bIgnrDrop On"        ;
                     else                           sData += "Saved bIgnrDrop Off"       ; break ;
            case 11: if(OM.CmnOptn.bSkipYieldErr  ) sData += "Saved SkipYieldErr On"     ;
                     else                           sData += "Saved SkipYieldErr Off"    ; break ;
        ...
        switch(iIndex) {
            ...
            case 2 : if(OM.CmnOptn.bIgnrVisn      ) sData += "Saved IgnrVision Off"       ;
                     else                           sData += "Saved IgnrVision On"        ; break ;
            ...
            case 5 : if(OM.CmnOptn.bLoadingStop   ) sData += "Saved LoadingStop Off"      ;
                     else                           sData += "Saved LoadingStop On"       ; break ;
            case 6 : if(OM.CmnOptn.bCheckFailCnt  ) sData += "Saved CheckFailCnt Off"     ;
                     else                           sData += "Saved CheckFailCnt On"      ; break ;
            //case 7 : if(OM.CmnOptn.bAutoConvesion ) sData += "Saved AutoConvesion On"    ;
            //         else                           sData += "Saved AutoConvesion Off"   ; break ;
            //case 8 : if(OM.CmnOptn.bAutoOperation ) sData += "Saved AutoOperation On"    ;
            //         else                           sData += "Saved AutoOperation Off"   ; break ;
            case 9 : if(OM.CmnOptn.bIgnrTrim      ) sData += "Saved IgnrTrim Off"         ;
                     else                           sData += "Saved IgnrTrim On"          ; break ;
            case 10: if(OM.CmnOptn.bIgnrDrop      ) sData += "Saved bIgnrDrop Off"        ;
                     else                           sData += "Saved bIgnrDrop On"         ; break ;
            case 11: if(OM.CmnOptn.bSkipYieldErr  ) sData += "Saved SkipYieldErr Off"     ;
                     else                           sData += "Saved SkipYieldErr On"      ; break ;
...
{
    UserFile.ClearDirDate(_sFolderPath , Now() - 30 * 13); //일년짜리 그래프때문에 12개월로 함.
}
...
//
    for(int k =0 ; k < OM.DevOptn.iDgChipCnt ; k++ )
    {
        ...
        for(int r = 0 ; r < OM.DevInfo.iRowCnt ; r++)
        {
            ...
            for(int c = 0 ; c < OM.DevInfo.iColCnt ; c++)
            {
                ...
                else if(iCChipRslt[r][c][k] == prDRNg  ) sTemp2.sprintf("%02d",(int)prDRNg  ) ;
                sRslt += sTemp2 +"_";
            }
            sRslt.Delete(sRslt.Length(),1);
    ...
    int iContactTemp;
    iContactTemp = TCU.GetCrntTemp(6);
    ...
    UserINI.Save(sPath.c_str()  , "ETC"  , "ContactTemp" , iContactTemp                         );
...
bool __fastcall CSPC::ReadLotMap (AnsiString sPath , TStringGrid *_sgLotMap)
{
    ...
    UserINI.Load(sPath.c_str()  , "ETC"  , "ContactTemp" , &iWRKTemp            );

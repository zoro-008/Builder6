...
//     //Check Running Status.
    if(LOT.m_bLotOpen&& !OM.MstOptn.bNotUstLot) {
    ...
    if(FM_GetLan() == lsKorean) {
        ...
        switch (index) {
        	case 1: //New.
                 ...
                 if(FM_MsgYesNo("Confirm" , (edToName -> Text + " Create a JOB FILE?").c_str()) == mrNo) return;
            ...
            case 2: //Copy.
                ...
                if(FM_MsgYesNo("Confirm" , (edFromName -> Text +" of into "+ edToName -> Text + " to JOB FILE of copy created?").c_str()) == mrNo) return ;

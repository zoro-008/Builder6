...
bool TFraMotr::CheckSafe(int _iId)
{
    ...
    if(_iId == (int)miPRB_XIdx){}
    if(_iId == (int)miPSB_XIdx){}
    if(_iId == (int)miWRK_ZTop){}
    if(_iId == (int)miWRK_YCam){}
    if(_iId == (int)miWRK_XBtm){}
    if(_iId == (int)miWRK_YBtm){}
    if(_iId == (int)miWRK_ZBtm){}
    if(_iId == (int)miREJ_XBtm){}
    if(_iId == (int)miSTL_YTop){}
    if(_iId == (int)miLDR_YCmp){}
    if(_iId == (int)miLDR_ZCmp){}
    if(_iId == (int)miULD_YCmp){}
    if(_iId == (int)miULD_ZCmp){}

...
bool CLineCrossPnt::Inspect(CImage * _pImg  , TRect _tRect1 , TRect _tRect2 , TPara _tPara , TRslt * _pRslt)
{
...
/*
void CLineCrossPnt::PaintRslt(HDC _hHdc , TRslt * _pRslt , LCP_Disp _tDisp , float _fScaleX, float _fScaleY)
{

...
typedef ENeptuneError (__stdcall *FPntcGetUserSet)(NeptuneCamHandle hCamHandle, PNEPTUNE_USERSET pUserSet);                                                                               extern FPntcGetUserSet ntcGetUserSet;                            
typedef ENeptuneError (__stdcall *FPntcSetUserSet)(NeptuneCamHandle hCamHandle, NEPTUNE_USERSET UserSet);                                                                                 extern FPntcSetUserSet ntcSetUserSet;                            
...
typedef ENeptuneError (__stdcall *FPntcSetPackageFeature)(NeptuneCamHandle hCamHandle, NEPTUNE_PACKAGE_FEATURE PackageFeature);                                                           extern FPntcSetPackageFeature ntcSetPackageFeature;

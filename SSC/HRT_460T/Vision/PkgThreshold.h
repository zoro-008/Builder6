...
class CThreshold_V01 : public CPkgBase
{
    ...
    public  :
        ...
        struct TMasterPara {
            ...
            DECLARATION(String,sOutRsltAdd );
            ...
            TMasterPara(){
                ...
                PROPERTY(List , String,sOutCntrdCntOfsXAdd ,"Out CentroidX Offset Add"   , "무게중심X 중심 offset 결과 주소");
                PROPERTY(List , String,sOutCntrdCntOfsYAdd ,"Out CentroidY Offset Add"   , "무게중심Y 중심 offset 결과 주소");
                ...
                PROPERTY(List , String,sOutRsltAdd         ,"Out Result Add     " , "결과 OK/NG 주소    ");

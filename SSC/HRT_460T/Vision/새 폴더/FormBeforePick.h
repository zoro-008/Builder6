...
#ifndef FormBeforePickH
#define FormBeforePickH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFrmBeforePick : public TForm
{
__published:	// IDE-managed Components
        ...
        void __fastcall sbBfpPxMinPerChange(TObject *Sender);
private:	// User declarations
        EN_VISN_ID m_iVisnId ;
public:		// User declarations
        __fastcall TFrmBeforePick(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFrmBeforePick *FrmBeforePick;
//---------------------------------------------------------------------------
#endif

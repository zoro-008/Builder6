...
{                                                                                   
    ...
    Value[miWRK_XVsn][pvWRK_XVsnWorkStartPs ].sName = "Work        " ;

    Value[miWRK_YVsn][pvWRK_YVsnWaitPs      ].sName = "Wait        " ;
    Value[miWRK_YVsn][pvWRK_YVsnWorkStartPs ].sName = "Work        " ;

    Value[miPSB_XMrk][pvPSB_XMrkWaitPs      ].sName = "Wait        " ;
    Value[miPSB_XMrk][pvPSB_XMrkWorkStartPs ].sName = "Work        " ;
    Value[miPSB_XMrk][pvPSB_XMrkVisnPs      ].sName = "VisnWork    " ;

    Value[miPSB_YMrk][pvPSB_YMrkWaitPs      ].sName = "Wait        " ;
    Value[miPSB_YMrk][pvPSB_YMrkWorkStartPs ].sName = "Work        " ;
    Value[miPSB_YMrk][pvPSB_YMrkVisnPs      ].sName = "VisnWork    " ;

    Value[miWK1_YFlp][pvWK1_YFlpNormalPs    ].sName = "Normal      " ;
    Value[miWK1_YFlp][pvWK1_YFlpInversePs   ].sName = "Inverse     " ;

    Value[miWK1_XIns][pvWK1_XInsWaitPs      ].sName = "Wait        " ;
    Value[miWK1_XIns][pvWK1_XInsStprPs      ].sName = "Stopper     " ;
    Value[miWK1_XIns][pvWK1_XInsOutPs       ].sName = "Out         " ;

    Value[miULD_YCmp][pvULD_YWaitPs         ].sName = "Wait        " ;
    Value[miULD_YCmp][pvULD_YPickPs         ].sName = "Pick        " ;
    Value[miULD_YCmp][pvULD_YWorkStartPs    ].sName = "Work        " ;

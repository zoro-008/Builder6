...
const int iControlHeight  = 18  ;
const int iStartRowOffset = 11  ;
const int iStartColOffset = 15  ;
...
void CAjinMotion::JH_ContiSetAxisMap (int _iCoord, int _iAxisCnt, int *_ipAxisNo)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
...
void CAjinMotion::JH_ContiSetAbsRelMode (int _iCoord, DWORD _dwAbsRelMode)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
...
void CAjinMotion::JH_ContiBeginNode (int _iCoord)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
...
void CAjinMotion::JH_ContiEndNode (int _iCoord)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
...
void CAjinMotion::JH_ContiStart (int _iCoord, DWORD _dwProfileset, int _iAngle)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
...
// _dAcc = 가속도
// _dDec = 감속도
void CAjinMotion::JH_LineMove(int _iCoord, double *_dpEndPos, double _dVel, double _dAcc, double _dDec)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL
...
void CAjinMotion::JH_CircleCenterMove(int _iCoord, int *_ipAxisNo, double *_dpCenterPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir)
{
#ifdef AJIN_AXT
#endif //AJIN_AXT
#ifdef AJIN_AXL

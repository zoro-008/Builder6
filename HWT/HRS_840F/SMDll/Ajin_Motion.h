...
//        SAjinPara AjinPara   ;
	...
	//Save AjinPara Functions.
        ...
        // 보간 구동을 위해 추가
        static void JH_ContiSetAxisMap    (int _iCoord, int _iAxisCnt, int *_ipAxisNo);
        static void JH_ContiSetAbsRelMode (int _iCoord , DWORD _dwAbsRelMode);
        static void JH_ContiBeginNode     (int _iCoord);
        static void JH_ContiEndNode       (int _iCoord);
        static void JH_ContiStart         (int _iCoord, DWORD _dwProfileset, int _iAngle);
        static void JH_LineMove           (int _iCoord, double *_dpEndPos, double _dVel, double _dAcc, double _dDec);
        static void JH_CircleCenterMove   (int _iCoord, int *_ipAxisNo, double *_dpCenterPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir);

...
void CActuators::DisplayList(TStringGrid *_sgTable)
{
    ...
    _sgTable -> ColWidths[1 ] = 128;
    _sgTable -> ColWidths[2 ] = 128;
    _sgTable -> ColWidths[3 ] = 38;
    _sgTable -> ColWidths[4 ] = 38;
    _sgTable -> ColWidths[5 ] = 38;
    _sgTable -> ColWidths[6 ] = 38;
    _sgTable -> ColWidths[7 ] = 38;
    _sgTable -> ColWidths[8 ] = 38;
    _sgTable -> ColWidths[9 ] = 38;
    _sgTable -> ColWidths[10] = 38;

        //Set Col.
    _sgTable -> Cells[0 ][0] = "No"      ;
    _sgTable -> Cells[1 ][0] = "Name"    ;
    _sgTable -> Cells[2 ][0] = "Comment" ;
    _sgTable -> Cells[3 ][0] = "xFwID"   ;
    _sgTable -> Cells[4 ][0] = "xBwID"   ;
    _sgTable -> Cells[5 ][0] = "yFwID"   ;
    _sgTable -> Cells[6 ][0] = "yBwID"   ;
    _sgTable -> Cells[7 ][0] = "FwOD"    ;
    _sgTable -> Cells[8 ][0] = "BwOD"    ;
    _sgTable -> Cells[9 ][0] = "FwTO"    ;
    _sgTable -> Cells[10][0] = "BwTO"    ;

...
void CIOs::DisplayList(bool _bOutput , TStringGrid *_sgTable , bool _bFixedWidth )
{
    ...
    if(_bFixedWidth)_sgTable -> ColWidths[1] = 40 ;  _sgTable -> Cells[1][0] = "Add"     ;
    if(_bFixedWidth)_sgTable -> ColWidths[2] = 45 ;  _sgTable -> Cells[2][0] = "HexAdd"  ;
    if(_bFixedWidth)_sgTable -> ColWidths[3] = 120;  _sgTable -> Cells[3][0] = "Name"    ;
    if(_bFixedWidth)_sgTable -> ColWidths[4] = 30 ;  _sgTable -> Cells[4][0] = "Invert"  ;
    if(_bFixedWidth)_sgTable -> ColWidths[5] = 120;  _sgTable -> Cells[5][0] = "Comment" ;
    if(_bFixedWidth)_sgTable -> ColWidths[6] = 35 ;  _sgTable -> Cells[6][0] = "Delay"   ;

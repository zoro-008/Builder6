...
/*20121123추가*/
typedef bool (__stdcall * PMT_GoAbsAcDc)(int _iAxisNo , double _dPos , double _dVel , double _dAcc , double _dDec);  //abs move
typedef void (__stdcall * PMT_GoIncAcDc)(int _iAxisNo , double _dPos , double _dVel , double _dAcc , double _dDec);  //Inc move  모션돈 확인은 GetStopInpos() 함수로.

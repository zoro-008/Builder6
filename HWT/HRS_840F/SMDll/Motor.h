...
//          bool               bHomeWithNSnsr ; //홈센서로 홈을 잡을 것인지 -로 홈을 잡을 것인지.
    ...
    public:
        ...
        // 20140415 juhyeon Motors.cpp에서 사용하기 위해 public로 옮김 (기존 Protected)
        SPara     Para     ;
        SUsrPara  UsrPara  ;
        SRptPara  RptPara  ;
        SStat     Stat     ;
        ...
        int GetPulseFromUnit(double _dUnit);  //유닛을 펄스로 바꿔줌.
        ...
        bool GoAbsAcDc(double _dPos , double _dVel , double _dAcc , double _dDec);
        void GoIncAcDc(double _dPos , double _dVel , double _dAcc , double _dDec);

...
// JH_
PMT_LineMove           JH_MT_LineMove           ;
PMT_ContiWriteClear    JH_MT_ContiWriteClear    ;
PMT_ContiSetAxisMap    JH_MT_ContiSetAxisMap    ;
PMT_ContiSetAbsRelMode JH_MT_ContiSetAbsRelMode ;
PMT_ContiBeginNode     JH_MT_ContiBeginNode     ;
PMT_ContiEndNode       JH_MT_ContiEndNode       ;
PMT_ContiStart         JH_MT_ContiStart         ;
PMT_CircleCenterMove   JH_MT_CircleCenterMove   ;
...
bool LoadProc()
{
    ...
    // JH_
    JH_MT_ContiBeginNode        =  (PMT_ContiBeginNode         )GetProcAddress(g_hSMLInst, "JH_MT_ContiBeginNode"     );
    JH_MT_ContiEndNode          =  (PMT_ContiEndNode           )GetProcAddress(g_hSMLInst, "JH_MT_ContiEndNode"       );
    JH_MT_ContiSetAbsRelMode    =  (PMT_ContiSetAbsRelMode     )GetProcAddress(g_hSMLInst, "JH_MT_ContiSetAbsRelMode" );
    JH_MT_ContiSetAxisMap       =  (PMT_ContiSetAxisMap        )GetProcAddress(g_hSMLInst, "JH_MT_ContiSetAxisMap"    );
    JH_MT_ContiStart            =  (PMT_ContiStart             )GetProcAddress(g_hSMLInst, "JH_MT_ContiStart"         );
    JH_MT_ContiWriteClear       =  (PMT_ContiWriteClear        )GetProcAddress(g_hSMLInst, "JH_MT_ContiWriteClear"    );
    JH_MT_LineMove              =  (PMT_LineMove               )GetProcAddress(g_hSMLInst, "JH_MT_LineMove"           );
    JH_MT_CircleCenterMove      =  (PMT_CircleCenterMove       )GetProcAddress(g_hSMLInst, "JH_MT_CircleCenterMove"   );

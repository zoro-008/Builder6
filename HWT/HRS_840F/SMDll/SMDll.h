...
extern "C" {
    ...
    /*20121123추가*/
    SML_API bool __stdcall MT_GoAbsAcDc(int _iAxisNo , double _dPos , double _dVel , double _dAcc , double _dDec);  //abs move
    SML_API void __stdcall MT_GoIncAcDc(int _iAxisNo , double _dPos , double _dVel , double _dAcc , double _dDec);  //Inc move  모션돈 확인은 GetStopInpos() 함수로.
    ...
    /*20150407추가*/ // juhyeon 보간 구동을 위해 추가
    ...
    SML_API void __stdcall MT_LineMove          (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpEndPos, double _dVel, double _dAcc, double _dDec);

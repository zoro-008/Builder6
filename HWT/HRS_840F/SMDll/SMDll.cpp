...
extern "C" SML_API
bool __stdcall MT_GoAbsAcDc (int _iAxisNo , double _dPos , double _dVel , double _dAcc , double _dDec)
{
    return MT.GoAbsAcDc(_iAxisNo , _dPos , _dVel , _dAcc , _dDec) ;

}

extern "C" SML_API
void __stdcall MT_GoIncAcDc (int _iAxisNo , double _dPos , double _dVel , double _dAcc , double _dDec)
{
   MT.GoIncAcDc(_iAxisNo , _dPos , _dVel , _dAcc , _dDec) ;
}
...
// 보간 구동을 위해 추가
extern "C" SML_API
void __stdcall JH_MT_ContiSetAxisMap(int _iCoord, int _iAxisCnt, int *_ipAxisNo)
{
    MT.JH_ContiSetAxisMap(_iCoord, _iAxisCnt, _ipAxisNo) ;
}

extern "C" SML_API
void __stdcall JH_MT_ContiSetAbsRelMode(int _iCoord, DWORD _dwAbsRelMode)
{
    MT.JH_ContiSetAbsRelMode(_iCoord, _dwAbsRelMode) ;
}

extern "C" SML_API
void __stdcall JH_MT_ContiBeginNode(int _iCoord)
{
    MT.JH_ContiBeginNode(_iCoord) ;
}

extern "C" SML_API
void __stdcall JH_MT_ContiEndNode(int _iCoord)
{
    MT.JH_ContiEndNode(_iCoord) ;
}

extern "C" SML_API
void __stdcall JH_MT_ContiStart(int _iCoord, DWORD _dwProfileset, int _iAngle)
{
    MT.JH_ContiStart(_iCoord, _dwProfileset, _iAngle) ;
}

extern "C" SML_API
void __stdcall JH_MT_LineMove(int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpEndPos, double _dVel, double _dAcc, double _dDec)
{
    MT.JH_LineMove(_iCoord, _ipAxisNo, _iAxisCnt, _dpEndPos, _dVel, _dAcc, _dDec);
}

extern "C" SML_API
void __stdcall JH_MT_CircleCenterMove(int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpCenterPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir)
{
    MT.JH_CircleCenterMove(_iCoord, _ipAxisNo, _iAxisCnt, _dpCenterPos, _dpEndPos, _dVel, _dAcc, _dDec, _dwCWDir);
}

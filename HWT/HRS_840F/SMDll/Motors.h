...
class CMotors
{
    ...
    protected:
        CMotor ** Motor ;
        //CAjinMotion * JH_AjinMotion ;
        int m_iMaxMotor ;
        int m_iAxisNo   ;
        int m_iMotorCnt ;

        //보간용.
        int JH_m_iMasterAxisPhyAdd ;
    ...
    public:
        ...
        bool   GoAbsAcDc(int _iAxisNo , double _dPos , double _dVel , double _dAcc , double _dDec);
        void   GoIncAcDc(int _iAxisNo , double _dPos , double _dVel , double _dAcc , double _dDec);
	...
	//Load Save Para Functions.
        ...
        */
        ...
        // 보간 구동을 위해 추가
        void JH_ContiWriteClear   (int _iCoord);
        void JH_ContiSetAxisMap   (int _iCoord, int _iAxisCnt, int *_ipAxisNo);
        void JH_ContiSetAbsRelMode(int _iCoord, DWORD _dwAbsRelMode);
        void JH_ContiBeginNode    (int _iCoord);
        void JH_ContiEndNode      (int _iCoord);
        void JH_ContiStart        (int _iCoord, DWORD _dwProfileset, int _iAngle);
        void JH_LineMove          (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpEndPos, double _dVel, double _dAcc, double _dDec);
        void JH_CircleCenterMove  (int _iCoord, int *_ipAxisNo, int _iAxisCnt, double *_dpCenterPos, double *_dpEndPos, double _dVel, double _dAcc, double _dDec, DWORD _dwCWDir);
};

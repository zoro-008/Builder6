...
#pragma link "CSPIN"
#pragma resource "*.dfm"
TFrmBfPick *FrmBfPick;
//---------------------------------------------------------------------------
__fastcall TFrmBfPick::TFrmBfPick(TComponent* Owner)
        : TForm(Owner)
{

}

void TFrmBfPick::Init()
{
    Left = 0 ;
    Top  = 0 ;
    ...
    FrmTrain -> SetTrainArea ( ((CBfPick *)VISN[m_iVisnId])-> Orig.pTrArea );
    FrmTrain -> SetTrainImg  ( ((CBfPick *)VISN[m_iVisnId])-> Orig.pTrImage);
...
void TFrmBfPick::ApplyPara(bool _bToTable)
{
    ...
    if(_bToTable) {
        ...
        //Dev Optn
        edCountX        -> Value     = ((CBfPick *)VISN[m_iVisnId])->GetInspColCnt() ;
        edCountY        -> Value     = ((CBfPick *)VISN[m_iVisnId])->GetInspRowCnt() ;
        ...
        //Dev Optn
        ((CBfPick *)VISN[m_iVisnId])->SetInspColCnt(edCountX        -> Value);
        ((CBfPick *)VISN[m_iVisnId])->SetInspRowCnt(edCountY        -> Value);
...
void __fastcall TFrmBfPick::btSaveClick(TObject *Sender)
{
    ApplyPara(false);
...
void __fastcall TFrmBfPick::FormShow(TObject *Sender)
{
...
void TFrmBfPick::FormShow(EN_PAGE_ID _iPage)
{
...
void __fastcall TFrmBfPick::sbThresholdLowChange(TObject *Sender)
{
    edThresholdLow -> Text = sbThresholdLow -> Position ;
}
//---------------------------------------------------------------------------

void __fastcall TFrmBfPick::sbThresholdHighChange(TObject *Sender)
{
    edThresholdHigh -> Text = sbThresholdHigh -> Position ;
}
//---------------------------------------------------------------------------

void __fastcall TFrmBfPick::sbPxMinPerChange(TObject *Sender)
{
...
void __fastcall TFrmBfPick::pcSetChange(TObject *Sender)
{
...
void __fastcall TFrmBfPick::btTrainClick(TObject *Sender)
{
...
void __fastcall TFrmBfPick::tmUpdateTimer(TObject *Sender)
{
    ...
    if(iPreX != ((CBfPick *)VISN[m_iVisnId]) -> Insp.pTrckInsp1 -> Left  ) bChangedTracker = true ;
    if(iPreY != ((CBfPick *)VISN[m_iVisnId]) -> Insp.pTrckInsp1 -> Top   ) bChangedTracker = true ;
    if(iPreW != ((CBfPick *)VISN[m_iVisnId]) -> Insp.pTrckInsp1 -> Width ) bChangedTracker = true ;
    if(iPreH != ((CBfPick *)VISN[m_iVisnId]) -> Insp.pTrckInsp1 -> Height) bChangedTracker = true ;
...
void __fastcall TFrmBfPick::btLtClick(TObject *Sender)
{
    ...
    float fXPitch   = (((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp2 -> Left - ((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp1 -> Left) / (float)VOM.VDevOptn.iCountX ;
    float fYPitch   = (((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp2 -> Top  - ((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp1 -> Top ) / (float)VOM.VDevOptn.iCountY ;
    float fTrackerW =  ((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp1 -> Width  ;
    float fTrackerH =  ((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp1 -> Height ;

    if(iSelButton == 0 ) {//left top
        fWidth  = fXPitch * 2;
        fHeight = fYPitch * 2;
        fLeft   = ((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp1 -> Left - fWidth /2 + fTrackerW/2;
        fTop    = ((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp1 -> Top  - fHeight/2 + fTrackerH/2;
    }
    else if(iSelButton == 1) { //right top
        fWidth  = fXPitch * 2;
        fHeight = fYPitch * 2;
        fLeft   = ((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp2 -> Left - fWidth /2 + fTrackerW/2;
        fTop    = ((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp1 -> Top  - fHeight/2 + fTrackerH/2;
    }
        ...
        fHeight = fYPitch * 2;
        fLeft   = ((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp1 -> Left - fWidth /2 + fTrackerW/2;
        fTop    = ((CBfPick *)VISN[m_iVisnId])->Insp.pTrckInsp2 -> Top  - fHeight/2 + fTrackerH/2;
    }

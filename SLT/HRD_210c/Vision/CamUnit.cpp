...
bool CImi::ApplyPara()
{
    ...
    FeatureProp.nValue = UserPara.iBrightness; if(ImCamSetFeatureValue(m_iImiCamNo, IMC_FEATURE_BRIGHTNESS, &FeatureProp)!= IMC_SUCCESS) {ShowMessage("Failed Set BRIGHTNESS"); return false ; }
    FeatureProp.nValue = UserPara.iSharpness ; if(ImCamSetFeatureValue(m_iImiCamNo, IMC_FEATURE_SHARPNESS , &FeatureProp)!= IMC_SUCCESS) {ShowMessage("Failed Set SHARPNESS "); return false ; }
    FeatureProp.nValue = UserPara.iGamma     ; if(ImCamSetFeatureValue(m_iImiCamNo, IMC_FEATURE_GAMMA     , &FeatureProp)!= IMC_SUCCESS) {ShowMessage("Failed Set GAMMA     "); return false ; }
    ...
    FeatureProp.nValue = UserPara.iShutter   ; if(ImCamSetFeatureValue(m_iImiCamNo, IMC_FEATURE_SHUTTER   , &FeatureProp)!= IMC_SUCCESS) {ShowMessage("Failed Set SHUTTER   "); return false ; } //외부에서 설정.
    FeatureProp.nValue = UserPara.iGain      ; if(ImCamSetFeatureValue(m_iImiCamNo, IMC_FEATURE_GAIN      , &FeatureProp)!= IMC_SUCCESS) {ShowMessage("Failed Set GAIN      "); return false ; }
    FeatureProp.nValue = UserPara.iPan       ; if(ImCamSetFeatureValue(m_iImiCamNo, IMC_FEATURE_PAN       , &FeatureProp)!= IMC_SUCCESS) {ShowMessage("Failed Set PAN       "); return false ; }
    FeatureProp.nValue = UserPara.iTilt      ; if(ImCamSetFeatureValue(m_iImiCamNo, IMC_FEATURE_TILT      , &FeatureProp)!= IMC_SUCCESS) {ShowMessage("Failed Set TILT      "); return false ; }

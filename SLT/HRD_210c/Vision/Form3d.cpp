...
__fastcall TFrm3d::TFrm3d(TComponent* Owner , IImage * _pImage , TRectTracker * _pTracker)
    : TForm(Owner)
{
    Left = 100 ;
    Top  = 100 ;
...
int __fastcall TFrm3d::DrawGLScene()
{
    ...
    int iLeft   = m_pTracker -> Left ;
    int iTop    = m_pTracker -> Top  ;
    int iRight  = m_pTracker -> GetRight ();
    int iBottom = m_pTracker -> GetBottom();

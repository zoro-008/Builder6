...
/*  Blob    */
typedef bool   (__stdcall *PBLB_Inspect   )(IImage * _pImg , TRect _tRect , BLB_Para _tPara , BLB_Fltr _tFltr , BLB_Rslt * _pRslt);
...
typedef bool   (__stdcall *POCV_Train     )(IImage * _pImg , TRect _Rect , OCV_TrPr _tTrPr ,  IArea * _pTrainArea , IImage * _pTrainImg) ;

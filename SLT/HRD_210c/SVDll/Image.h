...
class CImage : public IImage{
    ...
    public :
        ...
        //외부에서 더블버퍼링 할때
        //Scale
        int __stdcall ShowImg      (HDC _hHdc , int _x, int _y, int _iWidth, int _iHeight);
        int __stdcall ShowImgGrey  (HDC _hHdc , int _x, int _y, int _iWidth, int _iHeight);
        int __stdcall ShowImgFalse (HDC _hHdc , int _x, int _y, int _iWidth, int _iHeight);
        int __stdcall ShowImgColor (HDC _hHdc , int _x, int _y, int _iWidth, int _iHeight);
        int __stdcall ShowImgBinary(HDC _hHdc , int _x, int _y, int _iWidth, int _iHeight , int _iThreshold );
        int __stdcall ShowImgR     (HDC _hHdc , int _x, int _y, int _iWidth, int _iHeight);
        int __stdcall ShowImgG     (HDC _hHdc , int _x, int _y, int _iWidth, int _iHeight);
        int __stdcall ShowImgB     (HDC _hHdc , int _x, int _y, int _iWidth, int _iHeight);
        ...
        void    __stdcall ShowBitmap(HDC _hHdc, int _x, int _y, int _iWidth, int _iHeight);
        ...
        void __stdcall Scale (float _fScaleX , float _fScaleY , int _iMergeOption , IImage * _tDstImg);

...
//    DM.ARAY[riSTG].SetMaxColRow(MAX_WAFER_COL,MAX_WAFER_ROW);
    ...
    EPX._iEpxCnt = OM.DevOptn.iEpxClenCnt ;
                                                                               pbStatus -> Position = 80  ;
//    DM.ClearMap    (      );                                                   pbStatus -> Position = 90  ;
    DM.ARAY[riLDR].ClearMap();
    DM.ARAY[riPRB].ClearMap();
    DM.ARAY[riREV].ClearMap();
    DM.ARAY[riREF].ClearMap();
    DM.ARAY[riRDV].ClearMap();
    DM.ARAY[riRDF].ClearMap();
//    DM.ARAY[riHED].ClearMap();
//    DM.ARAY[riCST].ClearMap();
//    DM.ARAY[riSTG].ClearMap();
    DM.ARAY[riPSV].ClearMap();
    DM.ARAY[riPSF].ClearMap();

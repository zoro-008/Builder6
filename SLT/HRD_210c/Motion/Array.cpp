...
__fastcall CArray::CArray(void)
{
    ...
    if(bFirst) {
        ...
        clStat[csRsltH  ] = clBlack           ;//csBlack           = 16 ,
        clStat[csRsltI  ] = clBlack           ;//csBlack           = 16 ,
        clStat[csRsltJ  ] = clBlack           ;//csBlack           = 16 ,
        clStat[csRsltK  ] = clBlack           ;//csBlack           = 16 ,
        clStat[csRsltL  ] = clBlack           ;//csBlack           = 16 ,
        ...
        clStat[csWait2  ] = clHighlight       ;//csLime            = 31 ,
        clStat[csOrig   ] = clYellow          ;//etc               = 32 ,
        clStat[csStnd   ] = clFuchsia         ;//csStnd            = 33 ,
    ...
    m_sMenuName[csRsltA  ] = "RSLT_A"     ;
    m_sMenuName[csRsltB  ] = "RSLT_B"     ;
    m_sMenuName[csRsltC  ] = "RSLT_C"     ;
    m_sMenuName[csRsltD  ] = "RSLT_D"     ;
    m_sMenuName[csRsltE  ] = "RSLT_E"     ;
    m_sMenuName[csRsltF  ] = "RSLT_F"     ;
    m_sMenuName[csRsltG  ] = "RSLT_G"     ;
    m_sMenuName[csRsltH  ] = "RSLT_H"     ;
    m_sMenuName[csRsltI  ] = "RSLT_I"     ;
    m_sMenuName[csRsltJ  ] = "RSLT_J"     ;
    m_sMenuName[csRsltK  ] = "RSLT_K"     ;
    m_sMenuName[csRsltL  ] = "RSLT_L"     ;
    ...
    m_sMenuName[csWait2  ] = "WAIT2"     ;
    m_sMenuName[csOrig   ] = "ORIGIN"    ;
    m_sMenuName[csStnd   ] = "STAND"     ;

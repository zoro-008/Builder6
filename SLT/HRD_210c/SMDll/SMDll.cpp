...
extern "C" SML_API void              __stdcall MT_SetSubHome    (int _iAxisNo , bool _bOn                     ){       MT.SetSubHome    (_iAxisNo ,_bOn           );}
...
extern "C" SML_API void       __stdcall EM_Clear         (void     ){/*FrmErr -> Close();*/ EM.Clear();}
...
extern "C" SML_API void       __stdcall TL_MuteSnd       (         ){TL._bBuzzOff = false ; }

...
//***********************************************************************************************
    ...
    else if (m_iManNo == mcRAL_PreStprUp      ){}
    else if (m_iManNo == mcRAL_PreStprDn      ){}
    ...
    */
    ...
    else if (m_iManNo ==  mcPSB_TAlignBw       ){}
    ...
    else if (m_iManNo == mcULD_Home           ){m_iManStep = 10 ; m_iPreManStep = 0;}
...
//***********************************************************************************************
    ...
    else if (m_iManNo == mcRAL_PreStprUp       ) { IO_SetY(yPRB_Stpr , ccFwd);                        }
    else if (m_iManNo == mcRAL_PreStprDn       ) { IO_SetY(yPRB_Stpr , ccBwd);                        }
    ...
    else if (m_iManNo ==  mcRAL_VisnYZeroPs    ){MT_GoAbsRun(miWRK_YVsn, PM.GetValue(miWRK_YVsn,pvWRK_YVsnWait)); } // ); }
    ...
    else if (m_iManNo ==  mcPSB_TAlignBw       ){if(AT_Complete(aiPSB_AlgnFwBw , ccFwd)) AT_MoveCyl(aiPSB_AlgnFwBw , ccBwd);
...
//    else if (m_iManNo ==  mcPSB_TTrimDn        ){AT_MoveCyl(aiPSB_Trim  ,ccFwd);}
                                                 ...
                                                 if(AT_Complete(aiPSB_PshrDnUp , ccBwd)){ AT_MoveCyl(aiPSB_PshrDnUp , ccFwd); } }
    else if (m_iManNo == mcPSB_PshrFwBw       ){ if(AT_Complete(aiPSB_PshrFwBw , ccFwd)){ AT_MoveCyl(aiPSB_PshrFwBw , ccBwd); }
                                                 if(AT_Complete(aiPSB_PshrFwBw , ccBwd)){ AT_MoveCyl(aiPSB_PshrFwBw , ccFwd); } }
...
//        case  22: if(!AT_MoveCyl(aiPSB_FlprCmp , ccBwd)) return false ;
        ...
        case  23: if(!AT_MoveCyl(aiPSB_GripUpDn , ccBwd)) return false;
                  DM.ARAY[riPSB] = TempArray1 ;
                  MT_GoAbsMan(miPSB_TFlp , PM.GetValue(miPSB_TFlp , pvPSB_TFlpWait));

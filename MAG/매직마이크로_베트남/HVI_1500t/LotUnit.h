...
class CLot
{
    ...
    public :
        ...
        void __fastcall AddDayInfoChips   (int _iCntRslt0,
                                           int _iCntRslt1,
                                           int _iCntRslt2,
                                           int _iCntRslt3,
                                           int _iCntRslt4,
        ...
        void __fastcall AddLotInfoChips   (int _iCntRslt0,
                                           int _iCntRslt1,
                                           int _iCntRslt2,
                                           int _iCntRslt3,
                                           int _iCntRslt4,
        ...
        bool __fastcall WriteArayData(CArray * riAray                   ); //매거진 1개 일때만 랏드당 매거진 2개 이상 고려 안함.
        bool __fastcall ReadArayData (AnsiString sPath , CArray * riAray); //매거진 1개 일때만 랏드당 매거진 2개 이상 고려 안함.

...
bool __fastcall CVisnComUnit::WriteVisnModel()
{
    ...
    for(int i = 0 ; i< MAX_VISN ; i++) {
        iVsnNo = i;
        switch (iVsnNo) {
            //default     :                      return false ;
            case vsVisn1_1 : sName = "\\Change1_1.dat";  break ;  //수정.
            case vsVisn1_2 : sName = "\\Change1_2.dat";  break ;
            case vsVisn2_1 : sName = "\\Change2_1.dat";  break ;
            case vsVisn2_2 : sName = "\\Change2_2.dat";  break ;
            case vsVisn3_1 : sName = "\\Change3_1.dat";  break ;
            case vsVisn3_2 : sName = "\\Change3_2.dat";  break ;
        }

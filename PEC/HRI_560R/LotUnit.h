...
#define PSB_FAIL_DATA_FOLDER "d:\\Spc\\PSBFailData\\"
#define TRAY_INFO_FOLDER "d:\\SPC\\TrayInfo\\"
...
//            int        iCntHeatFail; // Heat Fail
        ...
        void __fastcall SaveTrayInfo();
        void __fastcall LoadTrayInfo();

        void __fastcall SavePSBInfo();
        void __fastcall LoadPSBInfo();

        void __fastcall WriteLotLog   () ;
        void __fastcall WriteLotDayLog() ;

        void __fastcall WriteTrayLog  () ;
        void __fastcall WritePSBLog   () ;
...
//                                               LotInfo.iCntHeatFail +=  _iCntHeatFail;
        ...
        void __fastcall UpdateTrayDate   (TStringGrid * _sgDate);
        void __fastcall UpdateLotName    (TStringGrid * _sgDate , TStringGrid * _sgLot );
        void __fastcall UpdateTrayLotName(TStringGrid * _sgDate , TStringGrid * _sgLot );
        void __fastcall DispLotDate      (TStringGrid * _sgDate , TStringGrid * _sgLot , TStringGrid * _sgLotInfo);
        void __fastcall DispTrayDate     (TStringGrid * _sgDate , TStringGrid * _sgLot , TStringGrid * _sgLotInfo);
        ...
        bool __fastcall WritePSBData (EN_ARAY_ID riId                   ); //대략 시간 없어서 그냥 추가.

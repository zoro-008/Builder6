...
#ifndef UnLoaderMotorH
#define UnLoaderMotorH
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
#include "Timer.h"
#include "DataMan.h"
...
class CUnLoaderMotor
{
	...
	void Reset     (); //리셑 버튼 눌렀을때 타는 함수.
        ...
        struct SStat {
            ...
            bool bReqInTray     ; //높이 조절 요청.
            bool bReqOutTray    ;
            bool bReqPaper      ;

            bool bReqInTrayStt  ; //첫위치 요청.
            bool bReqOutTrayStt ;
            bool bReqPaperStt   ;
    ...
    public:    /* Direct Accessable Var.  */
        ...
        void   SetMgzCnt(int _iCnt){m_iMgzCnt = _iCnt ;};

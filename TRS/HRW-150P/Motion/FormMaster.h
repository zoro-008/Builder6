...
__published:	// IDE-managed Components
        ...
        TGroupBox *GroupBox8;
        TButton *Button4;
        TCheckBox *cbFrstmachine;
        TCheckBox *cbDryRun;
        TCheckBox *cbIngrCvrSnsr;
        ...
        void __fastcall cbEncCount1Click(TObject *Sender);
        void __fastcall cbEncZ1Click(TObject *Sender);
        void __fastcall cbEncDir1Click(TObject *Sender);
        void __fastcall cbNear1Click(TObject *Sender);
        void __fastcall cbMLimit1Click(TObject *Sender);
        void __fastcall cbPLimit1Click(TObject *Sender);
        void __fastcall cbAlarm1Click(TObject *Sender);
        void __fastcall cbInpo1Click(TObject *Sender);
        void __fastcall cbPulse1Click(TObject *Sender);
        void __fastcall cbBusy1Click(TObject *Sender);
        void __fastcall cbSvReady1Click(TObject *Sender);
        void __fastcall cbStop1Click(TObject *Sender);
        void __fastcall cbEmgChange(TObject *Sender);
...
public:		// User declarations
        ...
        void __fastcall LoadCmnOption();
        void __fastcall SaveMstOption();
        void __fastcall LoadMstOption();

...
__published:	// IDE-managed Components
        ...
        TPanel *pnPump;
        TLabel *Label1;
        TRadioButton *rbUseTopNozzle;
        TRadioButton *rbUseBtmNozzle;
        TRadioButton *rbUseTwinNozzle;
        ...
        void __fastcall pnPumpClick(TObject *Sender);
        void __fastcall rbUseTopNozzleClick(TObject *Sender);

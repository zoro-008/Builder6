...
//#define TILT_PULSE_PER_REV 32768
//#define SPIN_PULSE_PER_REV 32768

//todo 왜 둘다 10000펄스 인가 ;;;;
...
public:
    bool GetRemote(){return m_bRemote;}
    int  GetOffLineStep(){return m_iOffLineStep;}
...
public:
    bool OpenPaixCtlNo(int nPaixCtlNo);
    bool ClosePaixCtl(void);
    bool ReOpenPaixCtl(void);

...
*/
    ...
    /*
      = 0 , //에러났던 곳을 다시 픽하고 안찝히면 다시 에러.
      = 1 , //픽했던데 다시 픽하고 없으면 그냥 다음 픽으로 넘어감 -> vsNomal.
      = 2 , //픽했던데 다시 픽하고 해당 에러열에서는 에러 스킵 -> vsNomal.
      = 3 , //픽했던데 다시 픽하고 해당 트레이에서는 에러 스킵 -> vsNomal.
      = 4 , //픽했던열 스킵으로 확인 하고 트레이 아웃.
      = 5 , //픽했던열 스킵으로 확인하고 트레이 아웃후 랏엔드요청.
...
void __fastcall TFrmOperation::Button4Click(TObject *Sender)
{
    ...
    String sTemp = "모든 리젝트레이를 클리어하시겠습니까?";

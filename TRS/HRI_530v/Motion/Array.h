    ...
    public:
        ...
        bool __fastcall SetStat( int r , int c , EN_CHIP_STAT _iStat) {
            if(r<0 || c<0 || r>=m_iMaxRow || c>=m_iMaxCol){
                Trace((m_sName + "RangeOver").c_str(), (String("r=")+r+ " c="+c + " Stat=" + _iStat + " m_iMaxRow="+m_iMaxRow +" m_iMaxCol="+m_iMaxCol).c_str());
                return false ;
            }
        ...
        EN_CHIP_STAT __fastcall GetStat   (int r , int c                      ) { if(r<0 || c<0 || r>=m_iMaxRow || c>=m_iMaxCol){Trace((m_sName + "RangeOver").c_str(), (String("r=")+r+ " c="+c +                     " m_iMaxRow="+m_iMaxRow +" m_iMaxCol="+m_iMaxCol).c_str()); return csRetFail ;} return CHPS[r][c].GetStat()   ; }
        bool         __fastcall CheckStat (int r , int c , EN_CHIP_STAT _iStat) { if(r<0 || c<0 || r>=m_iMaxRow || c>=m_iMaxCol){Trace((m_sName + "RangeOver").c_str(), (String("r=")+r+ " c="+c + " Stat=" + _iStat + " m_iMaxRow="+m_iMaxRow +" m_iMaxCol="+m_iMaxCol).c_str()); return false     ;} return GetStat(r,c) == _iStat ; }
        bool         __fastcall CheckExist(int r , int c                      ) { if(r<0 || c<0 || r>=m_iMaxRow || c>=m_iMaxCol){Trace((m_sName + "RangeOver").c_str(), (String("r=")+r+ " c="+c +                     " m_iMaxRow="+m_iMaxRow +" m_iMaxCol="+m_iMaxCol).c_str()); return false     ;} return CHPS[r][c].CheckExist(); }
        bool         __fastcall CheckRst  (int r , int c                      ) { if(r<0 || c<0 || r>=m_iMaxRow || c>=m_iMaxCol){Trace((m_sName + "RangeOver").c_str(), (String("r=")+r+ " c="+c +                     " m_iMaxRow="+m_iMaxRow +" m_iMaxCol="+m_iMaxCol).c_str()); return false     ;} return CHPS[r][c].CheckRst()  ; }
        ...
        //Sub Stat
        void __fastcall SetSubStat(int r , int c , int _iIdx , EN_CHIP_STAT _iSubStat) {
            if(r<0 || c<0 || r>=m_iMaxRow || c>=m_iMaxCol){
                Trace((m_sName + "RangeOver").c_str(), (String("r=")+r+ " c="+c + + " _iIdx" + _iIdx + " _iSubStat=" + _iSubStat + " m_iMaxRow="+m_iMaxRow +" m_iMaxCol="+m_iMaxCol).c_str());
                return ;
            }

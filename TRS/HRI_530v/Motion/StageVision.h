...
//---------------------------------------------------------------------------
class CStageVision : public CPartInterface
{
    public: //초기화 등등.
        //Constructor
        CStageVision ();
    ...
    public:
        ...
        //Ajin Trg 관련.
        void SetTrgPos(bool _bFrstVisn);
        void ResetTrgPos();

        //Visn Rslt Data
        bool GetVisnRslt(EN_ARAY_ID _iAray , int _iVisnNo);   //_iVisnNo = 1,2 ;
        ...
        bool VisnLotStart();
        bool SaveVisnLotNo(AnsiString _sLotNo);

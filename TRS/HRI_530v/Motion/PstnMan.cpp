...
void CPstnMan::Init()
{
    ...
    Value[miLDR_YIndx][pvLDR_YIndxWait       ].sName = "Wait       " ; //Value[miLDR_YIndx][pvLDR_YIndxWait       ].bCommon = true ;
    Value[miLDR_YIndx][pvLDR_YIndxGet        ].sName = "Get        " ;
    Value[miLDR_YIndx][pvLDR_YIndxWorkStt    ].sName = "WorkStt    " ;
    Value[miLDR_YIndx][pvLDR_YIndxOut        ].sName = "Out        " ;

    Value[miLSP_ZElev][pvLSP_ZElevWait       ].sName = "Wait       " ;
    Value[miLSP_ZElev][pvLSP_ZElevTop        ].sName = "Top        " ;
    Value[miLSP_ZElev][pvLSP_ZElevSperate    ].sName = "Sperate    " ;

    Value[miSRT_YPckr][pvSRT_YPckrWait       ].sName = "Wait       " ;
    Value[miSRT_YPckr][pvSRT_YPckrPick       ].sName = "Pick       " ;
    Value[miSRT_YPckr][pvSRT_YPckrZig        ].sName = "Zig        " ;
    Value[miSRT_YPckr][pvSRT_YPckrPocket     ].sName = "Pocket     " ;
    Value[miSRT_YPckr][pvSRT_YPckrReject1Stt ].sName = "Reject1Stt " ;
    Value[miSRT_YPckr][pvSRT_YPckrReject2Stt ].sName = "Reject2Stt " ;
    Value[miSRT_YPckr][pvSRT_YPckrReject3Stt ].sName = "Reject3Stt " ;
    Value[miSRT_YPckr][pvSRT_YPckrReject4Stt ].sName = "Reject4Stt " ;
    Value[miSRT_YPckr][pvSRT_YPckrPlace      ].sName = "Place      " ;

    Value[miSRT_ZPckr][pvSRT_ZPckrWait       ].sName = "Wait       " ;
    Value[miSRT_ZPckr][pvSRT_ZPckrMove       ].sName = "Move       " ;
    Value[miSRT_ZPckr][pvSRT_ZPckrSTGPick    ].sName = "StagePick  " ;
    Value[miSRT_ZPckr][pvSRT_ZPckrSTGPlace   ].sName = "StagePlace " ;
    Value[miSRT_ZPckr][pvSRT_ZPckrZIGPick    ].sName = "AlignPick  " ;
    Value[miSRT_ZPckr][pvSRT_ZPckrZIGPlace   ].sName = "AlignPlace " ;
    Value[miSRT_ZPckr][pvSRT_ZPckrRJTPick    ].sName = "RejctPick  " ;
    Value[miSRT_ZPckr][pvSRT_ZPckrRJTPlace   ].sName = "RejctPlace " ;
    Value[miSRT_ZPckr][pvSRT_ZPckrLDRPick    ].sName = "LoaderPick " ;
    Value[miSRT_ZPckr][pvSRT_ZPckrLDRPlace   ].sName = "LoaderPlace" ;
    Value[miSRT_ZPckr][pvSRT_ZPckrULDPick    ].sName = "UnlderPick " ;
    Value[miSRT_ZPckr][pvSRT_ZPckrULDPlace   ].sName = "UnlderPlace" ;

    Value[miSRT_XPckr][pvSRT_XPckrWait       ].sName = "Wait       " ;
    Value[miSRT_XPckr][pvSRT_XPckrPickStt    ].sName = "PickStt    " ;
    Value[miSRT_XPckr][pvSRT_XPckrZig        ].sName = "Zig        " ;
    Value[miSRT_XPckr][pvSRT_XPckrPocket     ].sName = "Pocket     " ;
    Value[miSRT_XPckr][pvSRT_XPckrReject1Stt ].sName = "Reject1Stt " ;
    Value[miSRT_XPckr][pvSRT_XPckrReject2Stt ].sName = "Reject2Stt " ;
    Value[miSRT_XPckr][pvSRT_XPckrReject3Stt ].sName = "Reject3Stt " ;
    Value[miSRT_XPckr][pvSRT_XPckrReject4Stt ].sName = "Reject4Stt " ;
    Value[miSRT_XPckr][pvSRT_XPckrPlaceStt   ].sName = "PlaceStt   " ;

    Value[miSTG_TTble][pvSTG_TTbleWait       ].sName = "Wait       " ;
    Value[miSTG_TTble][pvSTG_TTbleWork       ].sName = "Work       " ;

    Value[miSTG_YVisn][pvSTG_YVisnWait       ].sName = "Wait       " ;
    Value[miSTG_YVisn][pvSTG_YVisnTrgStt1    ].sName = "TargetStt1 " ;
    Value[miSTG_YVisn][pvSTG_YVisnTrgStt2    ].sName = "TargetStt2 " ;

    Value[miSRT_XExpd][pvSRT_XExpdWait       ].sName = "Wait       " ;
    Value[miSRT_XExpd][pvSRT_XExpdLDRTray    ].sName = "LoaderTray " ;
    Value[miSRT_XExpd][pvSRT_XExpdPocket     ].sName = "pocket     " ;
    Value[miSRT_XExpd][pvSRT_XExpdReject     ].sName = "Reject     " ;
    Value[miSRT_XExpd][pvSRT_XExpdZig        ].sName = "Zig        " ;
    Value[miSRT_XExpd][pvSRT_XExpdULDTray    ].sName = "UnloaderTray" ;


    Value[miULD_YIndx][pvULD_YIndxWait       ].sName = "Wait       " ;
    Value[miULD_YIndx][pvULD_YIndxGet        ].sName = "Get        " ;
    Value[miULD_YIndx][pvULD_YIndxWorkStt    ].sName = "WorkStt    " ;
    Value[miULD_YIndx][pvULD_YIndxOut        ].sName = "Out        " ;

    Value[miUSP_ZElev][pvUSP_ZElevWait       ].sName = "Wait       " ;
    Value[miUSP_ZElev][pvUSP_ZElevTop        ].sName = "Top        " ;
    Value[miUSP_ZElev][pvUSP_ZElevSperate    ].sName = "Sperate    " ;
      ...
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
    ...
    if(2 == GridInfo.iCol ) {
         ...
         if(GridInfo.iGrid == miLDR_YIndx) LDR.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miLSP_ZElev) LSP.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miSRT_YPckr) SRT.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miSRT_ZPckr) SRT.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miSRT_XPckr) SRT.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miSTG_TTble) STG.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miSTG_YVisn) VSN.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miSRT_XExpd) SRT.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miULD_YIndx) ULD.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
         if(GridInfo.iGrid == miUSP_ZElev) USP.MoveMotr((EN_MOTR_ID)GridInfo.iGrid , (EN_PSTN_ID)GridInfo.iRow);
    }
